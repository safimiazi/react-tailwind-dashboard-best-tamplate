...
import { Selectdata1, Teamuidata } from './teamdata';
                                            ...
                                            <div className="flex flex-wrap items-center justify-between">
                                                ...
                                                <div className="flex items-center">
                                                    <div className="input-group">
                                                        <input type="text" className="form-control w-full !bg-light border-0 !rounded-s-md" placeholder="Search Person Name" aria-describedby="search-team-member" />
                            ...
                            <div className="xxl:col-span-4 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12" key={Math.random()}>
                                <div className="box team-member-card">
                                    <div className="teammember-cover-image">
                                        ...
                                        <Link aria-label="anchor" to="#" className={`team-member-star text-${idx.class}`}>
                                    ...
                                    <ul className="list-none mb-0 mt-2">
                                        <li className="!pb-0">
                                            <div className="flex justify-between items-center">
                                                ...
                                                <button type="button" aria-label="button" className="ti-btn ti-btn-sm ti-btn-success" data-hs-overlay="#create-teamui-mem">
