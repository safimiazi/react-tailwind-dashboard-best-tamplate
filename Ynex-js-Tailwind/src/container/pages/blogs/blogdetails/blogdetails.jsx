                        ...
                        <div className="box">
                            <div className="box-body">
                                ...
                                <div className="sm:flex items-center">
                                    ...
                                    <div className="sm:mt-0 mt-2">
                                        <span className="badge bg-primary text-white me-2">Nature</span>
                            ...
                            <div className="box-body border-b dark:border-defaultborder/10 border-dashed">
                                <div className="sm:flex block items-center justify-between">
                                    ...
                                    <div className="btn-lists sm:mt-0 mt-2 space-x-3 rtl:space-x-reverse">
                                        <button aria-label="button" type="button" className="ti-btn ti-btn-sm ti-btn-primary text-primary" ><i className="ri-thumb-up-line"></i></button>
                                        <button aria-label="button" type="button" className="ti-btn ti-btn-sm ti-btn-primary text-primary"><i className="ri-share-line"></i></button>
                            ...
                            <div className="box-footer border-t blockt border-dashed text-center">
                                <div>
                                    <div className="btn-list space-x-3 rtl:space-x-reverse">
                                        <button aria-label="button" type="button" className="ti-btn ti-btn-sm ti-btn-primary ti-btn-wave text-primary">
                                            <i className="ri-facebook-line"></i>
                                        </button>
                                        <button aria-label="button" type="button" className="ti-btn ti-btn-sm ti-btn-secondary ti-btn-wave text-secondary">
                                            <i className="ri-twitter-line"></i>
                                        </button>
                                        <button aria-label="button" type="button" className="ti-btn ti-btn-sm ti-btn-warning ti-btn-wave text-warning">
                                            <i className="ri-instagram-line"></i>
                                        </button>
                                        <button aria-label="button" type="button" className="ti-btn ti-btn-sm ti-btn-success ti-btn-wave text-success">
                                ...
                                <ul className="list-group !rounded-md">
                                    <li className="list-group-item">
                                        <div className="flex gap-4 flex-wrap items-center">
                                            ...
                                            <div className="flex-grow">
                                                <Link to="#" className="text-[0.875rem] font-semibold mb-0">Animals</Link>
                                    ...
                                    <li className="list-group-item">
                                        <div className="flex gap-4 flex-wrap items-center">
                                            ...
                                            <div className="flex-grow">
                                                <Link to="#" className="text-[0.875rem] font-semibold mb-0">Travel</Link>
                                                <p className="mb-1 popular-blog-content text-truncate">
                                    ...
                                    <li className="list-group-item">
                                        <div className="flex gap-4 flex-wrap items-center">
                                            ...
                                            <div className="flex-grow">
                                                <Link to="#" className="text-[0.875rem] font-semibold mb-0">Interior</Link>
                                                <p className="mb-1 popular-blog-content text-truncate">
                                    ...
                                    <li className="list-group-item">
                                        <div className="flex gap-4 flex-wrap items-center">
                                            ...
                                            <div className="flex-grow">
                                                <Link to="#" className="text-[0.875rem] font-semibold mb-0">Nature</Link>
                                                <p className="mb-1 popular-blog-content text-truncate">
