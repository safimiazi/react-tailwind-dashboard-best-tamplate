                                    ...
                                    <div className="box text-default shadow border dark:border-defaulttextcolor/10">
                                        <div className="box-body !p-0">
                                            <div className="sm:grid grid-cols-12">
                                                <div className="xl:col-span-4 xxl:col-span-4 lg:col-span-4 md:col-span-4 col-span-12 about-company-stats-border">
                                                    <div className="text-center p-6 w-full h-full flex items-center justify-center">
                                                        <div>
                                                            <span className="font-semibold">Projects</span>
                                                            <p className="text-dark text-[2rem] mb-0"><CountUp className="count-up" end={137} />+</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="xl:col-span-4 xxl:col-span-4 lg:col-span-4 md:col-span-4 col-span-12 about-company-stats-border">
                                                    <div className="text-center p-6 w-full h-full flex items-center justify-center">
                                                        <div>
                                                            ...
                                                            <p className="text-dark text-[2rem] mb-0"><CountUp className="count-up" end={2500} />+</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="xl:col-span-4 xxl:col-span-4 lg:col-span-4 md:col-span-4 col-span-12">
                                                    <div className="text-center p-6 w-full h-full flex items-center justify-center">
                                                        <div>
                                                            <span className="font-semibold">Clients</span>
                                                            <p className="text-dark text-[2rem] mb-0"> <CountUp className="count-up" end={22} /></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
