                ...
                <div className="xl:col-span-9 col-span-12">
                    <div className="box">
                                    ...
                                    <div className="grid grid-cols-12 sm:gap-x-6 gap-y-6">
                                        <div className="xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-6 col-span-12">
                                            ...
                                            <div className="grid grid-cols-12 col-span-12 gap-2">
                                                <div className="xl:col-span-12 col-span-12">
                                                       <input type="text" className="form-control w-full !rounded-md !bg-light" id="Company-Name" placeholder="Company Name" 
                                                    defaultValue="SPRUKO TECHNOLOGIES" />
                                                </div>
                                                <div className="xl:col-span-12 col-span-12">
                                                    <textarea className="form-control w-full !rounded-md !bg-light" id="company-address" placeholder="Enter Address" rows={3}></textarea>
                                                </div>
                                                <div className="xl:col-span-12 col-span-12">
                                                ...
                                                <div className="xl:col-span-12 col-span-12">
                                                    <textarea className="form-control w-full !rounded-md !bg-light" id="invoice-subject" placeholder="Subject" rows={4}></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-6 col-span-12 sm:mt-0 mt-4">
                                            ...
                                            <div className="grid grid-cols-12 gap-2">
                                                <div className="xl:col-span-12 col-span-12">
                                                    <input type="text" className="form-control w-full !rounded-md !bg-light" id="customer-Name"
                                                     placeholder="Customer Name" defaultValue="Json Taylor" />
                                                </div>
                                                <div className="xl:col-span-12 col-span-12">
                                                    <textarea className="form-control w-full !rounded-md !bg-light" id="customer-address" placeholder="Enter Address" rows={3}></textarea>
                                                </div>
                                                <div className="xl:col-span-12 col-span-12">
                                        ...
                                        <table className="table whitespace-nowrap border dark:border-defaultborder/10 mt-3">
                                            ...
                                            <tbody>
                                                <tr className="border border-defaultborder dark:border-defaultborder/10">
                                                    ...
                                                    <td>
                                                        <textarea rows={1} className="form-control !w-auto !rounded-md !bg-light" placeholder="Enter Description"></textarea>
                                                    </td>
                                                    <td className="invoice-quantity-container">
                                                        <div className="input-group border dark:border-defaultborder/10 rounded-md !flex-nowrap">
                                                            ...
                                                            <input type="text" className="form-control  border-0 text-center !w-12 !p-1" aria-label="quantity" id="product-quantity4" defaultValue="1" />
                                                ...
                                                <tr className="border border-defaultborder dark:border-defaultborder/10">
                                                    ...
                                                    <td className="invoice-quantity-container">
                                                        <div className="input-group border dark:border-defaultborder/10 rounded-md  !flex-nowrap">
                                                            ...
                                                            <input type="text" className="form-control  border-0 text-center !w-12 !p-1" aria-label="quantity" id="product-quantity5" defaultValue="1" />
                        ...
                        <div className="box-footer text-end">
                            <button type="button" className="ti-btn ti-btn-light m-1"><i className="ri-eye-line me-1 align-middle inline-block"></i>Preview</button>
                            <button type="button" className="ti-btn bg-primary text-white m-1">Send Invoice <i className="ri-send-plane-2-line ms-1 align-middle inline-block"></i></button>
                        </div>
                    </div>
                </div>
                <div className="xl:col-span-3 col-span-12">
