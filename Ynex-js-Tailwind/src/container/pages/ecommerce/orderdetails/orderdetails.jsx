                ...
                <div className="xl:col-span-6 col-span-12">
                    <div className="box">
                                            ...
                                            <td>
                                                <div className="flex items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="mb-1">
                                                            <span className="me-1 inline-flex">Dial Size:</span><span className="text-[#8c9097] dark:text-white/50">44mm</span>
                                                        </div>
                                                        <div className="mb-1">
                                                            <span className="me-1 inline-flex">Color:</span><span className="text-[#8c9097] dark:text-white/50">Metallic Black</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div className="flex items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="mb-1">
                                                            <span className="me-1 inline-flex">Size:</span><span className="text-[#8c9097] dark:text-white/50">Large</span>
                                                        </div>
                                                        <div className="mb-1">
                                                            <span className="me-1 inline-flex">Color:</span><span className="text-[#8c9097] dark:text-white/50">Grey<span className="badge bg-success text-white ms-3">In Offer</span></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div className="flex items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="mb-1">
                                                            <span className="me-1 inline-flex">Color:</span><span className="text-[#8c9097] dark:text-white/50">Orange<span className="badge text-white bg-info ms-3">32% Off</span></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                        ...
                        <div className="box-footer border-t-0">
                            <div className="btn-list text-end space-x-3 rtl:space-x-reverse">
                                <button aria-label="button" type="button" className="ti-btn bg-primary text-white !py-1 !px-2 !font-medium" onClick={() => print()}><i className="ri-printer-line me-1 align-middle inline-block"></i>Print</button>
                    ...
                    <div className="box">
                        ...
                        <div className="box-body !p-0">
                            ...
                            <div className="p-4 border-b border-dashed dark:border-defaultborder/10">
                                ...
                                <p className="mb-2 text-[#8c9097] dark:text-white/50">
                                    <span className="font-semibold text-default">Ordered Date</span> 24,Nov 2022
                                </p>
                                <p className="mb-2 text-[#8c9097] dark:text-white/50">
                                    <span className="font-semibold text-default">Ordered Time :</span> 11:47AM
                                </p>
                                <p className="mb-0 text-[#8c9097] dark:text-white/50">
                                    <span className="font-semibold text-default">Payment Interface :</span> UPI
                                </p>
                            </div>
                        </div>
                        <div className="box-footer">Total <span className="text-success"> 294 items </span> purchased upto now </div>
                    </div>
                </div>
                <div className="xl:col-span-3 col-span-12">
                    <div className="box">
