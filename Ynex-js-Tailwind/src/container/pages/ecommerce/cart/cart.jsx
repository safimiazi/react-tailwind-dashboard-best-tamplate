                      ...
                      <tr className="border border-inherit border-solid dark:border-defaultborder/10" key={Math.random()}>
                        ...
                        <td className="product-quantity-container">
                          <div className="input-group border dark:border-defaultborder/10 rounded-md !flex-nowrap">
                            <button onClick={dec} aria-label="button" type="button" className="!border-0 ti-btn ti-btn-icon ti-btn-light  input-group-text flex-grow product-quantity-minus !mb-0" ><i className="ri-subtract-line"></i></button>
                            <input type="text" className="form-control form-control-sm border-0 text-center !w-[50px] !px-0" aria-label="quantity" id="product-quantity" defaultValue={idx.quantity} />
                            <button onClick={inc} aria-label="button" type="button" className="!border-0 ti-btn ti-btn-icon ti-btn-light input-group-text flex-grow product-quantity-plus !mb-0" ><i className="ri-add-line"></i></button>
                          </div>
                        </td>
                        <td ref={containerRef}>
                        ...
                        <td>
                          <div className="flex items-center">
                            ...
                            <Link to={`${import.meta.env.BASE_URL}pages/ecommerce/wishlist/`} className="hs-tooltip-toggle ti-btn ti-btn-icon bg-success text-white !font-medium me-1"> 
                            ...
                            <div className="hs-tooltip ti-main-tooltip ltr:[--placement:left] rtl:[--placement:right]">
                              <button type="button" onClick={() => Confirmalert(idx.id)} className="hs-tooltip-toggle ti-btn ti-btn-icon bg-danger text-white !font-medium btn-delete">
            ...
            <div className="box-body !p-0">
              <div className="p-4 border-b border-dashed dark:border-defaultborder/10">
                ...
                <div className="inline-flex" role="group" aria-label="Basic radio toggle button group">
                  ...
                  <label className="ti-btn ti-btn-outline-light !text-defaulttextcolor dark:hover:!bg-light dark:text-defaulttextcolor/70 !border-e-0 dark:!border-defaultborder/10 !rounded-e-none !font-medium" htmlFor="btnradio1">Free Delivery</label>
