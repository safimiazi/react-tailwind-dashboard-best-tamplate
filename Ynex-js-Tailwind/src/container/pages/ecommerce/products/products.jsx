                                    ...
                                    <div id="navbar-collapse-with-animation" className="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow xxl:block">
                                        <div className="xxl:flex flex-wrap gap-x-5 gap-y-2 mt-5 sm:mt-0">
                                            <ul className="navbar-nav me-auto lg:mb-0 xxl:items-center xxl:flex flex-grow mt-2 xxl:mt-0 items-center flex-wrap">
                                                ...
                                                <li className="nav-item mb-2 xxl:mb-0 hs-dropdown ti-dropdown [--placement:bottom-left] rtl:[--placement:bottom-right]">
                                                    <Link className="nav-link whitespace-nowrap text-defaulttextcolor dark:text-defaulttextcolor/70 dropdown-toggle" to="#"
                                                        id="navbarDropdown"
                                                        aria-expanded="false">
                                                        Kids<i
                                                ...
                                                <li className="nav-item xxl:mb-mb-0 mb-2 xxl:ms-0 !ms-4">
                                                    <div className="btn-group xxl:flex block hs-dropdown ti-dropdown [--placement:bottom-left] rtl:[--placement:bottom-right]">
                                ...
                                <div className="box product-card">
                                    <div className="box-body">
                                        ...
                                        <div className="product-icons">
                                            ...
                                            <Link aria-label="anchor" to={`${import.meta.env.BASE_URL}pages/ecommerce/cart/`} className="cart" onClick={() => { AddToCart(idx.id); }}><i
                                                className="ri-shopping-cart-line"></i></Link>
                                            <Link aria-label="anchor" to={`${import.meta.env.BASE_URL}pages/ecommerce/productdetails/`} className="view"><i
