                    ...
                    <div className="box">
                        ...
                        <div className="box-footer sm:flex block justify-between items-center">
                            <div className="text-[0.6875rem]">
                                ...
                                <span className="font-semibold ms-1 inline-flex">29,Oct 2022 - 12:47PM</span>
                            </div>
                            <div className="sm:mt-0 mt-2">
                ...
                <div className="xl:col-span-6 xxl:col-span-3 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                    <div className="box">
                        ...
                        <div className="box-footer sm:flex block justify-between items-center">
                            <div className="text-[0.6875rem]">
                                <span>Delivered on:</span>
                                <span className="font-semibold ms-1 inline-flex">4,Nov 2022 - 10:24AM</span>
                            </div>
                            <div className="sm:mt-0 mt-2">
                                <button type="button" className="ti-btn !py-1 !px-2 ti-btn-primary !text-[0.75rem] !font-medium">Rate Product<i className="bi bi-star-fill ms-2 text-xs text-warning"></i></button>
                            </div>
                ...
                <div className="xl:col-span-6 xxl:col-span-3 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                    <div className="box">
                        ...
                        <div className="box-footer sm:flex block justify-between items-center">
                            <div className="text-[0.6875rem]">
                                <span>Delivered on:</span>
                                <span className="font-semibold ms-1 inline-flex">04,Nov 2022 - 03:12PM</span>
                            </div>
                            <div className="sm:mt-0 mt-2">
                                <button type="button" className="ti-btn !py-1 !px-2 ti-btn-primary !text-[0.75rem] !font-medium">Rate Product<i className="bi bi-star-fill ms-2 text-xs text-warning"></i></button>
                            </div>
                ...
                <div className="xl:col-span-6 xxl:col-span-3 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                    <div className="box">
                        ...
                        <div className="box-footer sm:flex block justify-between items-center">
                            <div className="text-[0.6875rem]">
                                <span>Delivered on:</span>
                                <span className="font-semibold ms-1 inline-flex">22,Oct 2022 - 05:15PM</span>
                            </div>
                            <div className="sm:mt-0 mt-2">
                                <button type="button" className="ti-btn !py-1 !px-2 ti-btn-primary !text-[0.75rem] !font-medium">Rate Product<i className="bi bi-star-fill ms-2 text-xs text-warning"></i></button>
                            </div>
