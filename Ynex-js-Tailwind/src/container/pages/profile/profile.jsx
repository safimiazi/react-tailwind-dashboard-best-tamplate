...
import { Followersdata, Friendsdata, LightboxGallery, Personalinfodata, RecentPostsdata, Skillsdata, Suggestionsdata } from './profiledata';
                        ...
                        <div className="box-body !p-0">
                            ...
                            <div className="p-6 border-b border-dashed dark:border-defaultborder/10">
                                ...
                                <div className="mb-0">
                                    ...
                                    <div className="mb-0">
                                        <p className="mb-1">
                                            <Link to="#" className="text-primary"><u>https://www.spruko.com/</u></Link>
                                        </p>
                                        <p className="mb-0">
                                            <Link to="#" className="text-primary"><u>https://themeforest.net/user/ spruko/portfolio</u></Link>
                                        </p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="!p-4 border-b dark:border-defaultborder/10 border-dashed md:flex items-center justify-between">
                                        ...
                                        <div>
                                            ...
                                            <div className="progress progress-xs progress-animate">
                                                <div className="progress-bar bg-primary w-[60%]" style={{width:'60%'}} aria-valuenow={60} aria-valuemin={0} aria-valuemax={100}></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="!p-4">
                                                ...
                                                <ul className="list-none profile-timeline">
                                                    <li>
                                                        <div>
                                                            ...
                                                            <p className="mb-2">
                                                                <b>You</b> Commented on <b>alexander taylor</b> post <Link className="text-secondary" to="#"><u>#beautiful day</u></Link>.<span className="ltr:float-right rtl:float-left text-[.6875rem] text-[#8c9097] dark:text-white/50">24,Dec 2022 - 14:34</span>
                                                            </p>
                                                    ...
                                                    <li>
                                                        <div>
                                                            ...
                                                            <p className="mb-1">
                                                                <b>You</b> Commented on <b>Peter Engola</b> post <Link className="text-secondary" to="#"><u>#Mother Nature</u></Link>.<span className="ltr:float-right rtl:float-left text-[.6875rem] text-[#8c9097] dark:text-white/50">24,Dec 2022 - 14:34</span>
                                                            </p>
                                                                            ...
                                                                            <div>
                                                                                <div className="hs-dropdown ti-dropdown">
                                                                                    ...
                                                                                    <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                                                                                        <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block" to="#">Delete</Link></li>
                                                                                        <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block" to="#">Hide</Link></li>
                                                                    ...
                                                                    <div className="p-4 flex items-start flex-wrap">
                                                                        ...
                                                                        <div className="flex-grow">
                                                                            ...
                                                                            <p className="mb-4 profile-post-link">
                                                                                <Link to="#" className="text-[0.75rem] text-primary">
                                                                        ...
                                                                        <div className="flex-grow">
                                                                            ...
                                                                            <div className="flex leading-none justify-between mb-4">
                                                                                <div>
                                                                                    <Link aria-label="anchor" to="#">
                                                                                        <span className="avatar avatar-md me-1">
                                                                                            <img src={media40} alt="" className="rounded-md" />
                                                                                        </span>
                                                                                    </Link>
                                                                                    <Link aria-label="anchor" to="#">
                                                                                        <span className="avatar avatar-md me-1">
                                                                                            <img src={media45} alt="" className="rounded-md" />
                                                                                        </span>
                                                                                    </Link>
                                                                                </div>
                                                                            </div>
