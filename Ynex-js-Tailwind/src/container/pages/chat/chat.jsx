...
const [activeUser, setActiveUser] = useState({ name: "Emiley Jackson", image: face2 });
            ...
            <div className="main-chart-wrapper p-2 gap-2 lg:flex">
                <div className="chat-info border dark:border-defaultborder/10">
                    ...
                    <div className="tab-content" id="myTabContent">
                        ...
                        {chatData.map((section, index) => (
										<ul className="list-none mb-0 mt-2 chat-users-tab" key={index}>
											<li className="!pb-0 !pt-0" >
												<p className="text-[#8c9097] dark:text-white/50 text-[0.6875rem] font-semibold mb-2 opacity-[0.7]">{section.heading}</p>
											</li>
											{section.users.map((chatUser, userIndex) => (
												<li className={chatUser.class} key={userIndex}>
													<Link href="#!" onClick={() => handleUserClick(chatUser.name, chatUser.image)}>
														<div className="flex items-start">
															...
															<div className="flex-grow">
																<p className="mb-0 fw-semibold">
																	{chatUser.name} <span
																		className="ltr:float-right rtl:float-left text-[#8c9097] dark:text-white/50 font-normal text-[0.6875rem]">{chatUser.time}</span>
																</p>
                        ...
                        <div className="flex items-center leading-none">
                            ...
                            <div className="flex-grow">
                                <p className="mb-1 font-semibold text-[.875rem]">
                                    <Link to="#" className="chatnameperson responsive-userinfo-open !text-defaulttextcolor dark:text-defaulttextcolor/70">{activeUser.name} </Link>
                                </p>
                ...
                <PerfectScrollbar className="p-6">
                    ...
                    <div className="text-center mb-[3rem]">
                        ...
                        <p className="mb-1 text-[0.9375rem] font-semibold text-defaulttextcolor dark:text-defaulttextcolor/70 leading-none chatnameperson ">{activeUser.name}</p>
