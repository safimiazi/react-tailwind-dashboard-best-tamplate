...
<div className="grid grid-cols-12 gap-6">
    ...
    >
        ...
        <div className="box custom-box overlay-box  text-white">
            <img src={media35} className="box-img" alt="..." />
    ...
    //  onMouseEnter={OnDivChange} 
     >
        <div className="box custom-box overlay-box">
            <img src={media36} className="box-img" alt="..." />
            <div className="box-img-overlay flex flex-col p-0 !top-auto inset-x-0 bottom-0">
                <div className="box-body text-white">
                    <div className="box-text !text-white">
                        Image Overlays Are Awesome!
                    </div>
                    <div className="box-text mb-2 !text-white truncate">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even.</div>
                </div>
        ...
        <div className="box custom-box">
            <div className="box-header justify-between">
                ...
                <Link aria-label="anchor" className="hs-collapse-toggle inline-flex items-center gap-x-2 " to="#" id="hs-show-hide-collapse" data-hs-collapse="#hs-show-hide-collapse-heading">
