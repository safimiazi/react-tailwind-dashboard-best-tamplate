...
import { offcanvas1, offcanvas2, offcanvas3, offcanvas4, offcanvas5 } from '../../../components/ui/data/advanceduidata';
  ...
  <Fragment>
            ...
            <div className="grid grid-cols-12 gap-6">
                ...
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Placements" code={offcanvas5} customCardClass="custom-box">
                        <div className='sm:space-x-2 rtl:space-x-reverse'>
                            ...
                            <div id="hs-overlay-top" className="hs-overlay hidden ti-offcanvas ti-offcanvas-top !z-[105]" tabIndex={-1}>
                                ...
                                <div className="ti-offcanvas-body !h-[90%]">
                                    <p className="text-gray-800 dark:text-[#8c9097] dark:text-white/50 ps-4">
                                        ...
                                    </p>
                                </div>
                            </div>
