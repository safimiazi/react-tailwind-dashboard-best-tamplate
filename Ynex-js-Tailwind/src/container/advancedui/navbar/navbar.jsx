                    ...
                    <div className="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5">
                      ...
                      <div className="hs-mega-menu">
                         <div className="hs-dropdown ti-dropdown me-2">
                                                    <button className="hs-mega-menu-toggle hs-mega-menu-open:text-gray-500 hover:hs-mega-menu-open:text-gray-500 flex items-center w-full text-gray-600 hover:text-gray-400 font-medium dark:text-[#8c9097] dark:text-white/50 dark:hover:text-gray-500"
