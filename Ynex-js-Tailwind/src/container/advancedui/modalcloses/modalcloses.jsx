...
import { modal1, modal10, modal11, modal12, modal13, modal2, modal3, modal4, modal5, modal6, modal7, modal8, modal9 } from '../../../components/ui/data/advanceduidata';
...
const Modalcloses = () => {
  ...
  <Fragment>
      ...
      <div className="grid grid-cols-12 gap-6">
        <div className="xl:col-span-4 col-span-12">
          <Showcode title="Basic Modal" customCardClass="custom-box" code={modal1}>
              <Link to="#" className="hs-dropdown-toggle ti-btn ti-btn-primary-full" data-hs-overlay="#todo-compose">Launch demo modal
              </Link>
        ...
        <div className="xl:col-span-4 col-span-12">
          <Showcode title="Static Backdrop" code={modal2} customCardClass="custom-box">
              <Link to="#" className="hs-dropdown-toggle ti-btn ti-btn-primary-full " data-hs-overlay="#staticBackdrop">Launch static backdrop modal
              </Link>
        ...
        <div className="xl:col-span-4 col-span-12">
          <Showcode title="Scrolling Long Content" code={modal3} customCardClass="custom-box">
              <Link to="#" className="hs-dropdown-toggle ti-btn ti-btn-primary-full" data-hs-overlay="#exampleModalScrollable"> Scrolling long content
              </Link>
      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="xl:col-span-4 col-span-12">
          <Showcode title="Vertically Centered Scoralable" code={modal5} customCardClass="custom-box">
                    ...
                    <div className="ti-modal-body">
                      ...
                      <div className="mb-4">This
                        <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:right]">
                          <Link className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-secondary !mx-2" to="#">button
                      ...
                      <div>
                        ...
                        <div className="hs-tooltip ti-main-tooltip [--placement:top]">
                          <p className="text-muted mb-0"> <Link to="#">
                            <span className="hs-tooltip-toggle !text-primary mx-1">
                              That link
                              <span
                                className="hs-tooltip-content ti-main-tooltip-content py-1 px-2 !bg-black !text-xs !font-medium !text-white shadow-sm"
                                role="tooltip">
      ...
      <div className="grid grid-cols-12 gap-6">
        <div className="xl:col-span-4 col-span-12">
          <Showcode title="Using The Grid" code={modal7} customCardClass="custom-box">
        ...
        <div className="xl:col-span-4 col-span-12">
          <Showcode title="Optional sizes" code={modal9} customCardClass="custom-box">
