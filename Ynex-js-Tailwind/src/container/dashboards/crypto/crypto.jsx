                            ...
                            <ul className="list-none mb-0">
                                <li className="mb-4">
                                    <Link to="#">
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center">
                                                <img src={bitcoin} alt="" className="w-[1.75rem] h-[1.75rem] me-2" />
                                                <div>
                                ...
                                <li className="mb-4">
                                    <Link to="#">
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center">
                                                <img src={ethereum} alt="" className="w-[1.75rem] h-[1.75rem] me-2" />
                                                <div>
                                    ...
                                    <Link to="#">
                                        <div className="flex items-center justify-between">
                                            <div className="flex tems-center">
                                                <img src={dash} alt="" className="w-[1.75rem] h-[1.75rem] me-2" />
                                                <div>
                                ...
                                <li className="mb-4">
                                    <Link to="#">
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center">
                                                <img src={bytecoin} alt="" className="w-[1.75rem] h-[1.75rem] me-2" />
                                                <div>
                                ...
                                <li className="mb-4">
                                    <Link to="#">
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center">
                                                <img src={golem} alt="" className="w-[1.75rem] h-[1.75rem] me-2" />
                                                <div>
                                ...
                                <li className="mb-4">
                                    <Link to="#">
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center">
                                                <img src={Siacoin} alt="" className="w-[1.75rem] h-[1.75rem] me-2" />
                                                <div>
                                ...
                                <li className="">
                                    <Link to="#">
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center">
                                                <img src={monero} alt="" className="w-[1.75rem] h-[1.75rem] me-2" />
                                                <div>
                    ...
                    <div className="box">
                        ...
                        <div className="box-body">
                            <nav className="tab-style-1 sm:flex bg-light p-[0.65rem] rounded-sm mb-4" aria-label="Tabs">
                                <Link to="#" className="hs-tab-active:bg-primary hs-tab-active:text-white text-defaulttextcolor py-[0.35rem] px-4 flex-grow  text-sm font-medium text-center rounded-md hover:text-primary active" id="buy-crypto" data-hs-tab="#buy-crypto2" aria-controls="buycrypto">
                                    Buy
                                </Link>
                                <Link to="#" className="hs-tab-active:bg-primary hs-tab-active:text-white text-defaulttextcolor py-[0.35rem] px-4 text-sm flex-grow font-medium text-center  rounded-md hover:text-primary " id="sell-crypto" data-hs-tab="#sell-crypto2" aria-controls="sellcrypto">
                                    Sell
                                </Link>
                            </nav>
                                ...
                                <div className="tab-pane !border-0 show active !p-0" id="buy-crypto2" role="tabpanel">
                                    <div className="input-group mb-4 flex !flex-nowrap">
                                        <input type="text"
                                          ...
                                          <Select name="colors" data-trigger id="choices-single-default" options={Selectdata1} className="!rounded-e-md w-[5rem]"
                                    ...
                                    <div className="input-group mb-4 flex !flex-nowrap">
                                        <input type="text"
                                         ...
                                         <Select name="colors" data-trigger id="choices-single-default1" options={Selectdata2} className="!rounded-e-md w-[5rem]"
