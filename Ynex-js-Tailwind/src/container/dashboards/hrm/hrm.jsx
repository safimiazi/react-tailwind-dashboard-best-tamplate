            ...
            <div className="grid grid-cols-12 gap-x-6 col-span-12">
                <div className="xxl:col-span-3 xl:col-span-6 lg:col-span-6 md:col-span-12 col-span-12">
                    <div className="box">
                        ...
                        <div className="box-body !px-5 !py-6">
                            <div id="jobs-summary">
                                <JobsSummary/>
                            </div>
                        </div>
                                        ...
                                        <div className="flex flex-wrap flex-grow items-start justify-between">
                                            ...
                                            <div>
                                                <div className="hs-dropdown ti-dropdown">
                                                    <Link aria-label="anchor" to="#" className="text-[1rem] text-[#8c9097] dark:text-white/50">
                                ...
                                <table className="table whitespace-nowrap min-w-full">
                                    ...
                                    <tbody>
                                        <tr className="border-t border-defaultborder dark:border-defaultborder/10">
                                            <th scope="col">
                                                <div className="flex items-center leading-none w-36">
                                                    <img src={face2} alt="" className="avatar avatar-rounded me-4 !mb-0" />
                                                    <div>
                                            ...
                                            <td>
                                                <div className="hs-dropdown ti-dropdown">
                                                    <Link aria-label="anchor" to="#" className="ti-btn ti-btn-outline-light text-white !py-1 !px-2 !text-[0.75rem] !m-0 !gap-0 !font-medium">
                                        ...
                                        <tr className="border-t border-defaultborder dark:border-defaultborder/10">
                                            <th scope="row">
                                                <div className="flex items-center leading-none">
                                                    <img src={face8} alt="" className="avatar avatar-rounded me-4 !mb-0" />
                                                    <div>
                                        ...
                                        <tr className="border-t border-defaultborder dark:border-defaultborder/10">
                                            <th scope="row">
                                                <div className="flex items-center leading-none">
                                                    <img src={face13} alt="" className="avatar avatar-rounded me-4 !mb-0" />
                                                    <div>
                                        ...
                                        <tr className="border-t border-defaultborder dark:border-defaultborder/10">
                                            <th scope="row">
                                                <div className="flex items-center leading-none">
                                                    <img src={face11} alt="" className="avatar avatar-rounded me-4 !mb-0" />
                                                    <div>
                                        ...
                                        <tr className="border-t border-defaultborder dark:border-defaultborder/10">
                                            <th scope="row" className="border-bottom-0">
                                                <div className="flex items-center leading-none">
                                                    <img src={face5} alt="" className="avatar avatar-rounded me-4 !mb-0" />
                                                    <div>
