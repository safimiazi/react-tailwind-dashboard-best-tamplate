                    ...
                    <div className="grid grid-cols-12 gap-x-6">
                        <div className="xxl:col-span-6 col-span-12">
                            <div className="box overflow-hidden">
                                ...
                                <div className="box-body !p-0 ">
                                    <SimpleBar style={{ height: "350px" }} id="recent-jobs">
                                    <ul className="list-group list-group-flush max-h-[22.5rem]" >
                        ...
                        <div className="xxl:col-span-12 col-span-12">
                            <div className="box">
                                ...
                                <div className="box-body !p-0 recruiter">
                                    <div className="sm:grid xxxl:grid-cols-3 xxl:grid-cols-2 md:grid-cols-3 sm:grid-cols-2">
                                        <div className="col">
                                                ...
                                                <div className="flex items-start !mb-6">
                                                    ...
                                                    <div className="flex-grow">
                                                        <div className="recent-recruiter">
                                                            <Link to="#" className="font-semibold mb-0 text-truncate">Hr@Spruko</Link>
                                        ...
                                        <div className="col">
                                            <div className="p-4 md:border-e border-inline-e-dashed dark:border-white/10">
                                                <div className="flex items-start !mb-6">
                                                    ...
                                                    <div className="flex-grow">
                                                        <div className="recent-recruiter">
                                                            <Link to="#" className="font-semibold mb-0 text-truncate">Hr@Nicero</Link>
                                        ...
                                        <div className="col">
                                            <div className="p-4">
                                                <div className="flex items-start !mb-6">
                                                    ...
                                                    <div className="flex-grow">
                                                        <div className="recent-recruiter">
                                                            <Link to="#" className="font-semibold mb-0 text-truncate">JosephSmith</Link>
            ...
            <div className="grid grid-cols-12 gap-x-6">
                ...
                <div className="xxl:col-span-5 col-span-12">
                    <div className="box overflow-hidden">
                        ...
                        <div className="box-body !p-0 top-companies">
                            <div className="table-responsive">
                                <table className="table table-hover whitespace-nowrap min-w-full">
                                    <thead>
                                        <tr>
                                            <th scope="col" className="text-start name-col">Name</th>
                    ...
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="progress progress-lg mb-6 flex w-full">
                                <div className="flex flex-col justify-center text-center text-[8px] text-white overflow-hidden rounded-s-sm bg-primary w-[52%]" style={{width: "55%"}} aria-valuenow={52} aria-valuemin={0} aria-valuemax={100}>52%</div>
                                <div className="flex flex-col justify-center text-center text-[8px] text-white overflow-hidden rounded-none bg-secondary w-[12%]" style={{width: "12%"}} aria-valuenow={12} aria-valuemin={0} aria-valuemax={100}>12%</div>
                                <div className="flex flex-col justify-center text-center text-[8px] text-white overflow-hidden rounded-none bg-success w-[16%]" style={{width: "16%"}} aria-valuenow={16} aria-valuemin={0} aria-valuemax={100}>16%</div>
                                <div className="flex flex-col justify-center text-center text-[8px] text-white overflow-hidden rounded-none bg-warning w-[12%]" style={{width: "12%"}} aria-valuenow={12} aria-valuemin={0} aria-valuemax={100}>12%</div>
                                <div className="flex flex-col justify-center text-center text-[8px] text-white overflow-hidden rounded-e-sm bg-danger w-[8%]" style={{width: "8%"}} aria-valuenow={8} aria-valuemin={0} aria-valuemax={100}>8%</div>
                            </div>
                        ...
                        <div className="box-body">
                            <div className="table-responsive">
                                <table className="table whitespace-nowrap table-hover border table-bordered min-w-full">
                                    <thead>
                                        <tr>
                                            <th scope="row" className="ps-6"><input className="form-check-input" type="checkbox" id="checkboxNoLabel1" defaultValue="" aria-label="..." /></th>
                                    ...
                                    <tbody>
                                        {Data.map((idx)=>(
                                        <tr className="border hover:bg-gray-100 dark:hover:bg-light dark:border-defaultborder/10 border-defaultborder !border-x-0" key={Math.random()}>
                                            <th scope="row" className="ps-6"><input className="form-check-input" type="checkbox" id="checkboxNoLabel12" defaultChecked={idx.checked === 'defaultChecked'} defaultValue="" aria-label="..." /></th>
                                            <td>
