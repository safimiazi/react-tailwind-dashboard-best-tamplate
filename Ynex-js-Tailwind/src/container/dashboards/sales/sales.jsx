                            ...
                            <ul className="timeline-main mb-0 list-unstyled">
                                ...
                                <li className="mt-0 activity">
                                    <div className="text-[0.75rem]">
                                        <p className="mb-0">
                                            <span className="font-semibold text-primary">#Zlatan</span> <span className="ms-2 text-[0.75rem]"> shared a page. <Link to="https://themeforest.net/user/spruko/portfolio" target="_blank" className="text-success underline text-[0.6875rem]">https://themeforest.net/user/spruko/ portfolio</Link>
                                            </span>
                                        </p>
                                    </div>
                            ...
                            <div className="tab-menu-heading border-0 p-0 ms-auto sm:mt-0 mt-2">
                                <div className="tabs-menu-task me-3">
                                    <nav className="" aria-label="Tabs">
                                        <Link to="#" className="hs-tab-active:bg-secondary/10 hs-tab-active:text-secondary cursor-pointer text-defaulttextcolor py-[0.35rem] px-4 flex-grow  text-[0.75rem] font-medium text-center rounded-md hover:text-secondary active" id="active-item" data-hs-tab="#Active" aria-controls="Active">
                                            Active Tasks
                                        </Link>
                                        <Link to="#" className="hs-tab-active:bg-secondary/10 hs-tab-active:text-secondary cursor-pointer text-defaulttextcolor py-[0.35rem] px-4 text-[0.75rem] flex-grow font-medium text-center  rounded-md hover:text-secondary " id="Complete-item" data-hs-tab="#Complete" aria-controls="Complete">
                                            Completed Tasks
                                        </Link>
                                    </nav>
                                </div>
                                            ...
                                            <tbody>
                                                    ...
                                                    <td>
                                                        <div className="avatar-list-stacked !mb-0">
                                                            <span className="avatar avatar-xs !mb-0">
                                                                <img src={face2} alt="img" className="rounded-full" />
                                                            </span>
                                                            <span className="avatar avatar-xs !mb-0">
                                                                <img src={face8} alt="img" className="rounded-full" />
                                                            </span>
                                                            <span className="avatar avatar-xs !mb-0">
                                                                <img src={face2} alt="img" className="rounded-full" />
                                                            </span>
                                                ...
                                                <tr className="border-t border-inherit border-solid hover:bg-gray-100 dark:hover:bg-light dark:border-defaultborder/10">
                                                    ...
                                                    <td>
                                                        <div className="avatar-list-stacked !mb-0">
                                                            <span className="avatar avatar-xs !mb-0">
                                                                <img src={face6} alt="img" className="rounded-full" />
                                                            </span>
                                                            <span className="avatar avatar-xs !mb-0">
                                                                <img src={face9} alt="img" className="rounded-full" />
                                                            </span>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr className="border-t border-inherit border-solid hover:bg-gray-100 dark:hover:bg-light dark:border-defaultborder/10">
                                                    ...
                                                    <td>
                                                        <div className="avatar-list-stacked !mb-0">
                                                            <span className="avatar avatar-xs !mb-0">
                                                                <img src={face3} alt="img" className="rounded-full" />
                                                            </span>
                                                            <span className="avatar avatar-xs !mb-0">
                                                                <img src={face5} alt="img" className="rounded-full" />
                                                            </span>
                                                            <span className="avatar avatar-xs !mb-0">
                                                                <img src={face10} alt="img" className="rounded-full" />
                                                            </span>
                                                            <span className="avatar avatar-xs !mb-0">
                                                                <img src={face15} alt="img" className="rounded-full" />
                                                            </span>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr className="border-t border-inherit border-solid hover:bg-gray-100 dark:hover:bg-light dark:border-defaultborder/10">
                                                    ...
                                                    <td>
                                                        <div className="avatar-list-stacked !mb-0">
                                                            <span className="avatar avatar-xs !mb-0">
                                                                <img src={face11} alt="img" className="rounded-full" />
                                                            </span>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr className="border-t border-inherit border-solid hover:bg-gray-100 dark:hover:bg-light dark:border-defaultborder/10">
                                                    ...
                                                    <td>
                                                        <div className="avatar-list-stacked !mb-0">
                                                            <span className="avatar avatar-xs !mb-0">
                                                                <img src={face13} alt="img" className="rounded-full" />
                                                            </span>
                                                            <span className="avatar avatar-xs !mb-0">
                                                                <img src={face16} alt="img" className="rounded-full" />
                                                            </span>
                                                            <span className="avatar avatar-xs !mb-0">
                                                                <img src={face8} alt="img" className="rounded-full" />
                                                            </span>
                                            ...
                                            <tbody>
                                                ...
                                                <tr className="border-t border-inherit border-solid hover:bg-gray-100 dark:hover:bg-light dark:border-defaultborder/10">
                                                    ...
                                                    <td>
                                                        <div className="avatar-list-stacked !mb-0">
                                                            ...
                                                            <span className="avatar avatar-xs !mb-0">
                                                                <img src={face12} alt="img" className="rounded-full" />
                                                            </span>
                                                            <span className="avatar avatar-xs !mb-0">
                                                                <img src={face13} alt="img" className="rounded-full" />
                                                            </span>
                                                ...
                                                <tr className="border-t border-inherit border-solid hover:bg-gray-100 dark:hover:bg-light dark:border-defaultborder/10">
                                                    ...
                                                    <td>
                                                        <div className="avatar-list-stacked !mb-0">
                                                            <span className="avatar avatar-xs !mb-0">
                                                                <img src={face4} alt="img" className="rounded-full" />
                                                            </span>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr className="border-t border-inherit border-solid hover:bg-gray-100 dark:hover:bg-light dark:border-defaultborder/10">
                                                    ...
                                                    <td>
                                                        <div className="avatar-list-stacked !mb-0">
                                                            <span className="avatar avatar-xs !mb-0">
                                                                <img src={face1} alt="img" className="rounded-full" />
                                                            </span>
                                                            <span className="avatar avatar-xs !mb-0">
                                                                <img src={face2} alt="img" className="rounded-full" />
                                                            </span>
                        ...
                        <div className="box-body !p-0 customers">
                            <ul className="list-group my-1">
                                <li className="list-group-item !py-3 !border-0">
                                    <Link to="#" className="!border-0">
                                        <div className="flex items-start">
                                            <img className="avatar avatar-md me-4 my-auto" src={face2} alt="Image description" />
                                            <div className="mt-0">
                                ...
                                <li className="list-group-item !py-3 !border-0">
                                    <Link to="#" className="!border-0">
                                        <div className="flex items-start">
                                            <img className="avatar avatar-md me-4 my-auto" src={face1} alt="Image description" />
                                            <div className="mt-0">
                                ...
                                <li className="list-group-item !py-3 !border-0">
                                    <Link to="#" className="!border-0">
                                        <div className="flex items-start">
                                            <img className="avatar avatar-md me-4 my-auto" src={face5} alt="Image description" />
                                            <div className="mt-0">
                                ...
                                <li className="list-group-item !py-3 !border-0">
                                    <Link to="#" className="!border-0">
                                        <div className="flex items-start">
                                            <img className="avatar avatar-md me-4 my-auto" src={face7} alt="Image description" />
                                            <div className="mt-0">
                                ...
                                <li className="list-group-item !py-3 !border-0">
                                    <Link to="#" className="!border-0">
                                        <div className="flex items-start">
                                            <img className="avatar avatar-md me-4 my-auto" src={face9} alt="Image description" />
                                            <div className="mt-0">
                                ...
                                <li className="list-group-item !py-3 !border-0">
                                    <Link to="#" className="!border-0">
                                        <div className="flex items-start">
                                            <img className="avatar avatar-md me-4 my-auto" src={face11} alt="Image description" />
                                            <div className="mt-0">
                                                <p className="mb-1 font-semibold">Manuel Labor</p>
                                ...
                                <table className="table whitespace-nowrap table-bordered min-w-full">
                                    ...
                                    <tbody>
                                        ...
                                        <tr className="border-t border-inherit border-solid hover:bg-gray-100 dark:hover:bg-light dark:border-defaultborder/10" key={Math.random()}>
                                            ...
                                            <td>
                                                <span className={`badge bg-success/10 text-${idx.color}`}>{idx.status}</span>
                                            </td>
                                            <td>
