                    ...
                    <div className="grid grid-cols-12 gap-x-4">
                        ...
                        <div className="xxl:col-span-3 xl:col-span-3 lg:col-span-3 md:col-span-3 sm:col-span-6 col-span-12" key={Math.random()}>
                            <div className="box">
                                ...
                                <div className="flex items-center justify-between nft-like-section w-full px-6">
            ...
            <div className="grid grid-cols-12 gap-x-6">
                <div className="xxl:col-span-3 xl:col-span-12 lg:col-span-12 col-span-12">
                    <div className="box overflow-hidden">
                        ...
                        <div className="box-body !p-0" >
                            <SimpleBar style={{ height :" 450px"}} id="top-collector">
                            <div className="table-responsive">
                                <table className="table table-hover whitespace-nowrap min-w-full">
                                    <tbody>
                                        {TopCollectors.map((idx) => (
                                        <tr className='border !border-x-0 border-t-0 dark:border-defaultborder/10' key={Math.random()}>
                                            <td>
                                                <div className="flex items-center">
                                                    <div className="me-2">
                                            ...
                                            <td>
                                                <div className="progress progress-xs progress-animate !w-[3.125rem] nft-collector-progress">
                                                    <div className={`progress-bar bg-primary-gradient w-[${idx.progress}%]`} aria-valuenow={idx.progress} aria-valuemin={0} aria-valuemax={100}></div>
                                                </div>
                                            </td>
                                            <td>
                                ...
                                <div className="box collections-data">
                                    <div className="box-body">
                                        <div className="grid grid-cols-12 gap-2">
                                            ...
                                            <div className="col-span-6">
                                                <img src={nftimage7} alt=""
                                                    className="nft-featuredcollect-image" />
                                            </div>
                                            <div className="col-span-6">
                                                <img src={nftimage8} alt=""
                                                    className="nft-featuredcollect-image" />
                                            </div>
                                            <div className="col-span-6">
                                                <img src={nftimage9} alt=""
                                                    className="nft-featuredcollect-image" />
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <SwiperSlide>
                                <div className="box collections-data">
                                    <div className="box-body">
                                        <div className="grid grid-cols-12 gap-2">
                                            <div className="col-span-6">
                                                <img src={nftimage11} alt=""
                                                    className="nft-featuredcollect-image" />
                                            </div>
                                            <div className="col-span-6">
                                                <img src={nftimage12} alt=""
                                                    className="nft-featuredcollect-image" />
                                            </div>
                                            <div className="col-span-6">
                                                <img src={nftimage13} alt=""
                                                    className="nft-featuredcollect-image" />
                                            </div>
                                            <div className="col-span-6">
                                                <img src={nftimage14} alt=""
                                                    className="nft-featuredcollect-image" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="box-footer">
                                        <div className="flex items-center">
                                            <div className="flex items-center flex-grow">
                                                ...
                                                <div>
                                                    <p className="mb-0 font-semibold"><Link to="#">Melissa
                                                        Smith</Link></p>
                            ...
                            <SwiperSlide>
                                <div className="box custom-box collections-data">
                                    <div className="box-body">
                                        <div className="grid grid-cols-12 gap-2">
                                            <div className="col-span-6">
                                                <img src={nftimage10} alt=""
                                                    className="nft-featuredcollect-image" />
                                            </div>
                                            <div className="col-span-6">
                                                <img src={nftimage15} alt=""
                                                    className="nft-featuredcollect-image" />
                                            </div>
                                            <div className="col-span-6">
                                                <img src={nftimage17} alt=""
                                                    className="nft-featuredcollect-image" />
                                            </div>
                                            <div className="col-span-6">
                                                <img src={nftimage16} alt=""
                                                    className="nft-featuredcollect-image" />
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="box-body">
                            <div className="table-responsive">
                                <table className="table table-hover table-bordered whitespace-nowrap min-w-full">
                                    <thead>
                                        <tr>
                                            <th scope="row" className="text-start">Collection</th>
                                            <th scope="row" className="text-start">Rank</th>
                                            <th scope="row" className="text-start">Volume</th>
                                            <th scope="row" className="text-start">24h %</th>
                                            <th scope="row" className="text-start">7d %</th>
                                            <th scope="row" className="text-start">Floor Price</th>
                    ...
                    <div className="box overflow-hidden">
                        ...
                        <div className="box-body !p-0">
                            <ul className="list-group list-group-flush !border-0">
                                ...
                                <li className="list-group-item !border-t-0" key={Math.random()}>
                                    <Link to="#">
                                        <div className="flex flex-wrapitems-center justify-between">
                                            <div className="flex items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <span className="text-[#8c9097] dark:text-white/50 text-[0.75rem]">{idx.mail}<span className={`ms-2 text-${idx.color} text-[0.6875rem]`}><i className="ri-arrow-up-s-line align-middle me-1"></i>{idx.value}</span></span>
                                                </div>
                                            </div>
                                            <div>
