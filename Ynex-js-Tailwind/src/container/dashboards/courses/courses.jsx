...
import { Courselist, Earningsreport, Payouts } from './cousesdata';
                                ...
                                <div className="box-body">
                                    <div className="flex flex-wrap items-start gap-2">
                                        ...
                                        <div className="flex-grow">
                                            ...
                                            <Link to="#" className="text-primary text-[0.75rem]">View All<i className="ti ti-arrow-narrow-right ms-2 font-semibold inline-block"></i></Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="box-body">
                                    <div className="flex flex-wrap gap-2 items-start">
                                        ...
                                        <div className="flex-grow">
                                            ...
                                            <Link to="#" className="text-secondary text-[0.75rem]">View All<i className="ti ti-arrow-narrow-right ms-2 font-semibold inline-block"></i></Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="box-body">
                                    <div className="flex flex-wrap gap-2 items-start">
                                        ...
                                        <div className="flex-grow">
                                            ...
                                            <Link to="#" className="text-warning text-[0.75rem]">View All<i className="ti ti-arrow-narrow-right ms-2 font-semibold inline-block"></i></Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="box-body">
                                    <div className="flex flex-wrap gap-2 items-start">
                                        ...
                                        <div className="flex-grow">
                                            ...
                                            <Link to="#" className="text-danger text-[0.75rem]">View All<i className="ti ti-arrow-narrow-right ms-2 font-semibold inline-block"></i></Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <table className="table whitespace-nowrap min-w-full">
                                            ...
                                            <tbody>
                                                <tr className="border-t border-defaultborder dark:border-defaultborder/10">
                                                    ...
                                                    <td>
                                                        <div className="flex items-center">
                                                            <div className="progress progress-xs  course-status-progress progress-animate me-2" style={{width: "60%"}} aria-valuenow={60} aria-valuemin={0} aria-valuemax={100}>
                                                ...
                                                <tr className="border-t border-defaultborder dark:border-defaultborder/10">
                                                    ...
                                                    <td>
                                                        <div className="flex items-center">
                                                            <div className="progress progress-xs course-status-progress progress-animate me-2"  style={{width: "100%"}}aria-valuenow={100} aria-valuemin={0} aria-valuemax={100}>
                                                ...
                                                <tr className="border-t border-defaultborder dark:border-defaultborder/10">
                                                    ...
                                                    <td>
                                                        <div className="flex items-center">
                                                            <div className="progress progress-xs course-status-progress progress-animate me-2"  style={{width: "75%"}}aria-valuenow={75} aria-valuemin={0} aria-valuemax={100}>
                                                ...
                                                <tr className="border-t border-defaultborder dark:border-defaultborder/10">
                                                    ...
                                                    <td>
                                                        <div className="flex items-center">
                                                            <div className="progress progress-xs course-status-progress progress-animate me-2"  style={{width: "55%"}}aria-valuenow={55} aria-valuemin={0} aria-valuemax={100}>
                                                ...
                                                <tr className="border-t border-defaultborder dark:border-defaultborder/10">
                                                    ...
                                                    <td className="border-bottom-0">
                                                        <div className="flex items-center">
                                                            <div className="progress progress-xs course-status-progress progress-animate me-2"  style={{width: "29%"}}aria-valuenow={29} aria-valuemin={0} aria-valuemax={100}>
