...
const Colors = () =>{ 
   const Background = [
    ...
    {id:3, color:"warning" ,text:'warning'},
    {id:4, color:"info" ,text:'info'},
    {id:5, color:"success" ,text:'success'},
    {id:6, color:"danger" ,text:'danger'},
    {id:7, color:"light" ,text:'light'},
    {id:8, color:"black" ,text:'dark'},
]
  return(
  <Fragment>
                        ...
                        <div className="box-body">
                            <div className="grid md:grid-cols-8 grid-cols-1 sm:grid-cols-4  items-center">
                                ...
                                <div className="p-4 col-span-1" key={Math.random()}>
                                    ...
                                    <p className="pb-0 mb-0 font-semibold text-center"><code>bg-{idx.text}</code></p>
                                </div>
                                ))}
                            </div>
                        </div>
                        ...
                        <div className="box-body">
                            <div className="grid md:grid-cols-8 grid-cols-1 sm:grid-cols-4  items-center">
                                ...
                                <div className="p-4 col" key={Math.random()}>
                                    ...
                                    <p className="pb-0 mb-0 font-semibold text-center"><code>border-{idx.text}</code></p>
                                </div>
                                ))}
                            </div>
                        </div>
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-12 col-span-12">
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="grid sm:grid-cols-9 items-center">
                                <div className="p-4 col">
