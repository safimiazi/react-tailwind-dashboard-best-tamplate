...
const Avatars = () => {
  ...
  <Fragment>
            ...
            <div className="grid grid-cols-12 gap-6">
                ...
                <div className="xl:col-span-4 lg:col-span-6 md:col-span-12 sm:col-span-12 col-span-12">
                    <Showcode title="Avatar Sizes <p class='subtitle text-muted text-[0.75rem] font-normal'>Avatars of different sizes</p>" code={avatar2}>
                ...
                <div className="xl:col-span-4 lg:col-span-6 md:col-span-12 sm:col-span-12 col-span-12">
                    <Showcode title="Avatar With Icons <p class='subtitle text-muted text-[0.75rem] font-normal'>Avatar contains icons to perform respective action.</p>" code={avatar3}>
                            {AvatarIcon.map((idx) => (
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-4 lg:col-span-6 md:col-span-12 sm:col-span-12 col-span-12">
                    <Showcode title="Avatar With Online Status Indicator <p class='subtitle text-muted text-[0.75rem] font-normal'>avatars having online status indicator.</p>" code={avatar4}>
                ...
                <div className="xl:col-span-4 lg:col-span-6 md:col-span-12 sm:col-span-12 col-span-12">
                    <Showcode title="Avatar With Offline Status Indicator <p class='subtitle text-muted text-[0.75rem] font-normal'>avatars having a offline status indicator.</p>" code={avatar5}>
                ...
                <div className="xl:col-span-4 lg:col-span-6 md:col-span-12 sm:col-span-12 col-span-12">
                    <Showcode title="Avatar With Number Badges <p class='subtitle text-muted text-[0.75rem] font-normal'>Avatar numbers indicates the no. of unread notififactions/messages.</p>" code={avatar6}>
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-4 lg:col-span-6 md:col-span-12 sm:col-span-12 col-span-12">
                    <Showcode title="Avatar with Initials <p class='subtitle text-muted text-[0.75rem] font-normal'>Avatar contains intials when user profile doesn't exist.</p>" code={avatar7}>
                ...
                <div className="xl:col-span-4 lg:col-span-6 md:col-span-12 sm:col-span-12 col-span-12">
                    <Showcode title="Stacked Avatar <p class='subtitle text-muted text-[0.75rem] font-normal'>Group of avatars stacked together.</p>" code={avatar8}>
                ...
                <div className="xl:col-span-4 lg:col-span-6 md:col-span-12 sm:col-span-12 col-span-12">
                    <Showcode title="Rounded Stacked Avatarsv <p class='subtitle text-muted text-[0.75rem] font-normal'>Group of avatars stacked together.</p>" code={avatar9}>
                            <div className="avatar-list-stacked">
                            {StackedAvatars.map((idx)=>(
