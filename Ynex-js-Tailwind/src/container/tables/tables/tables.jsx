...
import { Colortables, Table1data, Table5data, Table6data, tablehead } from './tablesdata';
  ...
  <Fragment>
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Basic Tables" code={tabledata1} customCardClass="custom box">
                ...
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Bordered Tables" code={tabledata2} customCardClass="custom box">
                            <div className="table-responsive">
                                        ...
                                        {Table5data.map((idx) => (
                                            <tr className="border-b border-defaultborder " key={Math.random()}>
                                                ...
                                                <button type="button" className="ti-btn !py-1 !px-2 !text-[0.75rem] ti-btn-danger-full btn-wave">
                                                    <i className="ri-delete-bin-line align-middle me-2 inline-block"></i>Delete
                                                </button>
                                                </td>
                                            </tr>
                                        ))}
            ...
            <div className="grid grid-cols-12 gap-6">
                ...
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Table Head Info"  code={tabledata21} 
                                    ...
                                    <tbody>
                                        {Colortables.map((idx) => (
                                            <tr key={Math.random()} className={`${idx.class1} border-b border-defaultborder`}>
                                                ...
                                                <td><span 
                                                // bg={idx.color} 
                                                className={`badge ${idx.class2} ${idx.color}`}>Processed</span></td>
                                                <td>{idx.quantity}</td>
                                                <td>{idx.price}</td>
                                            </tr>
                                        ))}
                                        ...
                                        <tr className="border-b border-defaultborder">
                                            ...
                                            <td>
                                                <div className="avatar-list-stacked">
                                                    ...
                                                    <Link className="avatar avatar-sm bg-primary text-white avatar-rounded" to="#">
                                                        +4
                                                    </Link>
                                                </div>
                                            </td>
