...
import { SingleButtons } from './dropdownsdata';
import Pageheader from '../../../components/common/pageheader/pageheader';
import Showcode from '../../../components/ui/showcode/showcode';
import { dropdown1, dropdown10, dropdown11, dropdown12, dropdown13, dropdown14, dropdown15, dropdown16, dropdown17, dropdown18, dropdown19, dropdown2, dropdown20, dropdown21, dropdown22, dropdown3, dropdown4, dropdown5, dropdown6, dropdown7, dropdown8, dropdown9 } from '../../../components/ui/data/uielementsdata';
...
const Dropdowns = () => {
  ...
  <Fragment>
                            ...
                            <div className="ti-btn-list flex align-center flex-wrap">
                                <div className="hs-dropdown ti-dropdown me-2">
                                    ...
                                    <ul className="hs-dropdown-menu ti-dropdown-menu hidden"
                                        ...
                                        <li><Link className="ti-dropdown-item" to="#">Another
                                            action</Link></li>
                                ...
                                <div className="hs-dropdown ti-dropdown">
                                    <Link className="ti-btn ti-btn-secondary-full ti-dropdown-toggle !py-2"
                                        to="#" id="dropdownMenuLink" aria-expanded="false">
                                        Dropdown link<i
                                            className="ri-arrow-down-s-line align-middle ms-1 inline-block"></i>
                                    </Link>
                                    <ul className="hs-dropdown-menu ti-dropdown-menu hidden"
                            ...
                            <div className="ti-btn-list">
                                ...
                                <div className="ti-btn-group" key={Math.random()}>
                                    <div className="hs-dropdown ti-dropdown [--placement:bottom-left] rtl:[--placement:bottom-right]" >
                                        <button className={`ti-btn ti-btn-${idx.class}-full ti-dropdown-toggle me-2`} type="button"
                                        ...
                                        <ul className="hs-dropdown-menu ti-dropdown-menu hidden"
                                            ...
                                            <li><Link className="ti-dropdown-item" to="#">Action</Link>
                                            </li>
                                            <li><Link className="ti-dropdown-item" to="#">Another
                                                action</Link></li>
                                            <li><Link className="ti-dropdown-item" to="#">Something
                                                else here</Link></li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Rounded Dropdown Buttons" code={dropdown3}>
                        <div className="ti-btn-list">
                                ...
                                <div className="ti-btn-group" key={Math.random()}>
                                    <div className="hs-dropdown ti-dropdown">
                                        <button className={`ti-btn ti-btn-${idx.class}-full ti-dropdown-toggle !rounded-full me-2`} type="button"
                                            id="dropdownMenuButton2"
                                            aria-expanded="false">
                                            Action<i
                                                className="ri-arrow-down-s-line align-middle ms-1 inline-block"></i>
                ...
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Outline Button Dropdowns" code={dropdown4}>
                        <div className="ti-btn-list">
                                ...
                                <div className="ti-btn-group" key={Math.random()}>
                                    <div className="hs-dropdown ti-dropdown [--placement:bottom-left] rtl:[--placement:bottom-right]">
                                        <button className={`ti-btn ti-btn-outline-${idx.class} ti-dropdown-toggle me-2`} type="button"
                                            id="dropdownMenuButton2"
                                            aria-expanded="false">
                                            Action<i
                                                className="ri-arrow-down-s-line align-middle ms-1 inline-block"></i>
                ...
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Outline Button Dropdowns" code={dropdown5}>
                        <div className="ti-btn-list">
                                ...
                                <div className="ti-btn-group" key={Math.random()}>
                                    <div className="hs-dropdown ti-dropdown">
                                        <button className={`ti-btn ti-btn-outline-${idx.class} ti-dropdown-toggle !rounded-full me-2`} type="button"
                                            id="dropdownMenuButton2"
                                            aria-expanded="false">
                                            Action<i
                                                className="ri-arrow-down-s-line align-middle ms-1 inline-block"></i>
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Split Dropdowns" code={dropdown6}>
                            
                            <div className="ti-btn-list">
                                {SingleButtons.map((idx) =>(
  <div className="ti-btn-group" key={Math.random()}>
  <div className="hs-dropdown ti-dropdown me-2 [--placement:bottom-left] rtl:[--placement:bottom-right]">
      <button
                            ...
                            <div className="ti-btn-group my-1 me-2">
                                <div className="ti-btn-group my-1 me-2 ti-dropdown hs-dropdown">
                                    ...
                                    <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                                        ...
                                        <li><Link className="ti-dropdown-item" to="#">Separated
                                            link</Link></li>
                                    </ul>
                                </div>
                            </div>
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-3 col-span-12">
                    <Showcode title="Dropup" code={dropdown8}>
                            <div className="hs-dropdown ti-dropdown [--placement:bottom-left] rtl:[--placement:bottom-right] m-1">
                    ...
                    <Showcode title="Active" code={dropdown11}>
                            <div className="hs-dropdown ti-dropdown">
                                ...
                                <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                                    ...
                                    <li><Link className="ti-dropdown-item active" to="#"
                ...
                <div className="xl:col-span-3 col-span-12">
                    <Showcode title="Disabled" code={dropdown12}>
                            <div className="hs-dropdown ti-dropdown [--placement:bottom-left] rtl:[--placement:bottom-right]">
                                ...
                                <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                                    <li><Link className="ti-dropdown-item" to="#">Regular link</Link></li>
                                    <li><Link className="ti-dropdown-item disabled" to="#"
                                        aria-current="true">Active
                                        link</Link></li>
                                    <li><Link className="ti-dropdown-item" to="#">Another link</Link></li>
                                </ul>
                    ...
                    <Showcode title="Auto Close Behaviour" code={dropdown13}>
                            <div className="ti-btn-list">
                                <div className="ti-btn-group ">
                                    <div className="hs-dropdown ti-dropdown">
                                        <button className="ti-btn ti-btn-primary-full ti-dropdown-toggle me-2" type="button"
                                            id="defaultDropdown"
                                            aria-expanded="false">
                                            Default dropdown<i
                                        ...
                                        <ul className="hs-dropdown-menu ti-dropdown-menu hidden"
                                            ...
                                            <li><Link className="ti-dropdown-item" to="#">Menu item</Link>
                                            </li>
                                            <li><Link className="ti-dropdown-item" to="#">Menu item</Link>
                                            </li>
                                            <li><Link className="ti-dropdown-item" to="#">Menu item</Link>
                                ...
                                <div className="ti-btn-group">
                                    <div className="hs-dropdown ti-dropdown">
                                        <button className="ti-btn ti-btn-secondary-full ti-dropdown-toggle me-2"
                                ...
                                <div className="ti-btn-group">
                                    <div className="hs-dropdown ti-dropdown">
                                        <button className="ti-btn ti-btn-info-full ti-dropdown-toggle me-2" type="button"
                                ...
                                <div className="ti-btn-group">
                                    <div className="hs-dropdown ti-dropdown">
                                        <button className="ti-btn ti-btn-warning-full ti-dropdown-toggle me-2" type="button"
            ...
            <div className="grid grid-cols-12 gap-6">
                    ...
                    <Showcode title="Alignment Options" code={dropdown15}>
                            <div>
                                <div className="ti-dropdown hs-dropdown">
                                    <button className="ti-btn ti-btn-primary-full ti-dropdown-toggle mb-0 me-2 !py-2"
                                ...
                                <div className="ti-dropdown hs-dropdown">
                                    <button type="button"
                                        className="ti-btn ti-btn-secondary-full ti-dropdown-toggle mb-0 me-2 !py-2" aria-expanded="false">
                                ...
                                <div className="ti-dropdown hs-dropdown" data-hs-dropdown-strategy="absolute">
                                    <button type="button" id="hs-dropdown-left-but-right-on-lg"
                                        className="ti-btn ti-btn-info-full ti-dropdown-toggle mb-0 me-2 !py-2" aria-expanded="false">
                                ...
                                <div className="ti-dropdown hs-dropdown" data-hs-dropdown-strategy="absolute">
                                    <button type="button" id="hs-dropdown-right-but-left-on-lg"
                                        className="ti-btn ti-btn-warning-full ti-dropdown-toggle mb-0 me-2 !py-2" aria-expanded="false">
                                ...
                                <div className="hs-dropdown ti-dropdown [--placement:left-top]">
                                    <button id="hs-dropright2" type="button"
                                        className="hs-dropdown-toggle ti-dropdown-toggle me-2 ti-btn ti-btn-success-full !py-2">
                                        <svg className="w-auto h-2.5 text-white" width="16" height="16"
                                            viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M11 1L5.31305 7.16086C5.13625 7.35239 5.13625 7.64761 5.31305 7.83914L11 14"
                                ...
                                <div className="hs-dropdown ti-dropdown [--placement:right-top]">
                                    <button id="hs-dropright1" type="button"
                                        className="hs-dropdown-toggle ti-dropdown-toggle ti-btn ti-btn-primary-full me-2 !py-2">
                                        Dropend
                                        <svg className="w-auto h-2.5 ti-dropdown-caret !text-white" width="16"
                                            height="16" viewBox="0 0 16 16" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="hs-dropdown ti-dropdown [--placement:bottom-left] rtl:[--placement:bottom-right]">
                                    <button id="hs-dropup1" type="button"
                                        className="hs-dropdown-toggle ti-dropdown-toggle ti-btn ti-btn-success-full me-2 !py-2">
                                        Dropup
                                        <svg className="hs-dropdown-open:rotate-180 ti-dropdown-caret !text-white"
                                            width="16" height="16" viewBox="0 0 16 16" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="xl:col-span-3 col-span-12">
                    <Showcode title="Dark Dropdowns" code={dropdown16}>
                            <div className="ti-dropdown hs-dropdown">
                                <button className="ti-btn ti-btn-dark ti-dropdown-toggle !py-2" type="button"
                                    id="dropdownMenuButton34" aria-expanded="false">
                                    Dropdown button<i className="ri-arrow-down-s-line align-middle inline-block"></i>
                                </button>
                                <ul
                                    className="hs-dropdown-menu ti-dropdown-menu !bg-black dark:!text-defaulttextcolor/10 hidden">
                    ...
                    <Showcode title="Customer Dropdown Menus's" code={dropdown17}>
                            <div className="ti-btn-list">
                                <div className="ti-dropdown hs-dropdown [--placement:bottom-left] rtl:[--placement:bottom-right]">
                                    <button className="ti-btn ti-btn-primary-full ti-dropdown-toggle me-2 !py-2"
                                        type="button" aria-expanded="false">
                                ...
                                <div className="ti-dropdown hs-dropdown">
                                    <button className="ti-btn ti-btn-secondary-full ti-dropdown-toggle me-2 !py-2"
                                        type="button" aria-expanded="false">
                                ...
                                <div className="ti-dropdown hs-dropdown">
                                    <button className="ti-btn ti-btn-warning-full ti-dropdown-toggle me-2 !py-2"
                                        type="button" aria-expanded="false">
                                    ...
                                    <ul className="hs-dropdown-menu ti-dropdown-menu dropmenu-item-warning hidden">
                                        <li><Link className="ti-dropdown-item active" to="#">Active</Link>
                                        </li>
                                        <li><Link className="ti-dropdown-item" to="#">Action</Link></li>
                                        <li><Link className="ti-dropdown-item" to="#">Another
                                            action</Link></li>
                                ...
                                <div className="ti-dropdown hs-dropdown">
                                    <button className="ti-btn ti-btn-info-full ti-dropdown-toggle me-2 !py-2" type="button" aria-expanded="false">
                                ...
                                <div className="ti-dropdown hs-dropdown">
                                    <button className="ti-btn ti-btn-success ti-dropdown-toggle me-2 !py-2" type="button" aria-expanded="false">
                                ...
                                <div className="ti-dropdown hs-dropdown">
                                    <button className="ti-btn ti-btn-danger ti-dropdown-toggle me-2 !py-2" type="button" aria-expanded="false">
                ...
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Ghost Button Dropdowns" code={dropdown18}>
                            <div className="ti-btn-list">
                                ...
                                <div className="ti-dropdown hs-dropdown">
                                    <button type="button"
                                        className="ti-btn ti-btn-ghost-secondary ti-dropdown-toggle me-2 !py-2 !shadow-none" aria-expanded="false">
                                        Secondary<i className="ri-arrow-down-s-line align-middle inline-block"></i>
                                    </button>
                                    <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                                        <li><Link className="ti-dropdown-item" to="#">Action</Link></li>
                                ...
                                <div className="ti-dropdown hs-dropdown">
                                    <button type="button"
                                        className="ti-btn ti-btn-ghost-success ti-dropdown-toggle me-2 !py-2 !shadow-none" aria-expanded="false">
                                        Success<i className="ri-arrow-down-s-line align-middle inline-block"></i>
                                    </button>
                                    <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                                        <li><Link className="ti-dropdown-item" to="#">Action</Link></li>
                                ...
                                <div className="ti-dropdown hs-dropdown">
                                    <button type="button"
                                        className="ti-btn ti-btn-ghost-warning ti-dropdown-toggle me-2 !py-2 !shadow-none" aria-expanded="false">
                                        Warning<i className="ri-arrow-down-s-line align-middle inline-block"></i>
                                    </button>
                                    <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                                        <li><Link className="ti-dropdown-item" to="#">Action</Link></li>
                                ...
                                <div className="ti-dropdown hs-dropdown">
                                    <button type="button"
                                        className="ti-btn ti-btn-ghost-danger ti-dropdown-toggle me-2 !py-2 !shadow-none" aria-expanded="false">
                                        Danger<i className="ri-arrow-down-s-line align-middle inline-block"></i>
                                    </button>
                                    <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                                        <li><Link className="ti-dropdown-item" to="#">Action</Link></li>
