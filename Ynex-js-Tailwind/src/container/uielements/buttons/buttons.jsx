...
import { Defaultbutton, Lightbuttons, gradientbuttons, outlinebuttons } from './buttonsdata';
import { Link } from 'react-router-dom';
import Showcode from '../../../components/ui/showcode/showcode';
import { buttons1, buttons10, buttons11, buttons12, buttons13, buttons14, buttons15, buttons16, buttons17, buttons18, buttons19, buttons2, buttons20, buttons21, buttons22, buttons3, buttons4, buttons5, buttons6, buttons7, buttons8, buttons9 } from '../../../components/ui/data/uielementsdata';
            ...
            <div className="grid grid-cols-12 gap-x-6">
                ...
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Disable State With anchor Tags" code={buttons12}>
                            <div className="ti-btn-list flex space-x-2 rtl:space-x-reverse">
                                ...
                                <div className="space-x-2 rtl:space-x-reverse">
                                    <Link to="#" className="ti-btn ti-btn-primary ti-btn-disabled" aria-disabled="true">Primary
                                        link</Link>
                                    <Link to="#" className="ti-btn ti-btn-secondary ti-btn-disabled" aria-disabled="true">Link</Link>
                                </div>
                            </div>
                        </Showcode>
                </div>
                ...
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Icon Buttons" code={buttons14}>
                            <div className="ti-btn-list md:flex block space-x-4 rtl:space-x-reverse">
                                <div className="md:mb-0 mb-2 space-x-1 rtl:space-x-reverse">
                ...
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Buttons With Different Shadows" code={buttons18}>
                            <div className="ti-btn-list flex space-x-4 rtl:space-x-reverse">
                                <div className="me-[3rem] space-x-1 rtl:space-x-reverse">
                    ...
                    <Showcode title="Block Buttons" code={buttons22}>
                            <div className="ti-btn-list space-x-2 rtl:space-x-reverse">
                                <div className="grid gap-2 mb-6">
                                    ...
                                    <button className="ti-btn ti-btn-secondary-full ti-btn-wave" type="button">Button</button>
                                </div>
                                <div className="grid gap-2 md:block space-x-2 rtl:space-x-reverse">
                                    <button className="ti-btn ti-btn-info-full ti-btn-wave" type="button">Button</button>
                                    <button className="ti-btn ti-btn-success-full ti-btn-wave" type="button">Button</button>
                                </div>
