...
import { progress1, progress10, progress11, progress12, progress13, progress14, progress2, progress3, progress4, progress5, progress6, progress7, progress8, progress9 } from '../../../components/ui/data/uielementsdata';
import { Custom, Gradient, animated, basicprogress, colorprogress, lables, stripped } from './progressbardata';
            ...
            <div className="grid grid-cols-12 gap-6">
                ...
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Different Colored Progress" code={progress2}>
                            ...
                            <div className="progress mb-4" aria-valuenow={idx.now} aria-valuemin={0} key={Math.random()}
                                aria-valuemax={100}>
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Stripped Progress" code={progress3}>
                            {stripped.map((idx)=>(
                            <div className="progress mb-4" aria-valuenow={idx.valunow} aria-valuemin={0} aria-valuemax={100} key={Math.random()}>
