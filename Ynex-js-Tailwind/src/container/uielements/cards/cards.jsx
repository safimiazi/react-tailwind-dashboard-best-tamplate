...
import { Backgroundcards, Gridcards } from './cardsdata';
...
const Cards = () =>{ 
    ...
    useEffect(() => {
      const handleBodyClick = (e) => {
        // Check if the click is outside the box and it is in full-screen mode
        if (isFullscreen && !document.querySelector('.box').contains(e.target)) {
    ...
    const handleBoxClick = (e) => {
      e.stopPropagation();
      // Add your logic here if needed when clicking inside the box
    };
  return(
  <Fragment>
            ...
            <div className="grid grid-cols-12 md:gap-x-6">
                ...
                <div className="xxl:col-span-3 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                    <div className="box">
                        ...
                        <div className="box-body">
                            <Link to="#" className="card-link text-primary me-2">Card link</Link>
                            <Link to="#" className="card-link text-secondary inline-block">Another
                                link</Link>
                        </div>
                    </div>
                </div>
                ...
                <div className="xxl:col-span-6 xl:col-span-6 lg:col-span-12 col-span-12">
                    ...
                    <div className="grid grid-cols-12 gap-x-6">
                        <div className="xl:col-span-4 col-span-12">
                            <div className="box">
                                <div className="box-body">
                                    <img src={media25} className="card-img mb-4 !rounded-md"
                                        alt="..." />
                                    ...
                                    <Link to="#" className="ti-btn ti-btn-primary-full">Purchase</Link>
                                </div>
                            </div>
                        </div>
                        <div className="xl:col-span-4 col-span-12">
                            <div className="box">
                                <div className="box-body">
                                    <img src={media26} className="card-img mb-4 !rounded-md"
                                        alt="..." />
                                    <h6 className="box-title font-semibold">Product B</h6>
                                    <p className="card-text mb-4">With supporting text below as a natural
                                        lead-in to additional content.</p>
                                    <Link to="#" className="ti-btn ti-btn-secondary-full">Purchase</Link>
                                </div>
                            </div>
                        </div>
                        <div className="xl:col-span-4 col-span-12">
                            <div className="box">
                                <div className="box-body">
                                    <img src={media27} className="card-img mb-4 !rounded-md"
                                        alt="..." />
                                ...
                                <div className="box-body">
                                    <div className="mb-2">
                                        <span className="avatar avatar-md">
                                            <img src={face15} alt="img" className="!rounded-md" />
                                        </span>
                                    </div>
                                    ...
                                    <Link to="#" className="ti-btn ti-btn-primary-full">Go
                                        somewhere</Link>
                                </div>
                            </div>
                        </div>
                        <div className="xl:col-span-4 col-span-12">
                            <div className="box text-center">
                                <div className="box-body">
                                    <div className="mb-2">
                                        <span className="avatar avatar-md">
                                            <img src={face3} alt="img" className="!rounded-md" />
                                        </span>
                                    </div>
                        ...
                        <div className="xl:col-span-4 col-span-12">
                            <div className="box text-end">
                                <div className="box-body">
                                    <div className="mb-2">
                                        <span className="avatar avatar-md">
                                            <img src={face11} alt="img" className="!rounded-md" />
                                        </span>
                                    </div>
            ...
            <div className="grid grid-cols-12 md:gap-x-6">
                    ...
                    <div className="box">
                        <div className="box-header">
                            <div className="flex align-center w-full">
                                <img src={face11} alt="img" className="avatar avatar-rounded me-2 !mb-0" />
                    ...
                    <div className="box text-center">
                        ...
                        <div className="box-body !pt-1">
                            ...
                            <div className="ti-btn-list">
                                <button type="button" aria-label="button" className="!ms-2 ti-btn ti-btn-icon ti-btn-facebook btn-wave">
                                    <i className="ri-facebook-line"></i>
                                </button>
                                <button type="button" aria-label="button" className="!ms-2 ti-btn ti-btn-icon ti-btn-twitter btn-wave">
                                    <i className="ri-twitter-line"></i>
                                </button>
                                <button type="button" aria-label="button" className="!ms-2 ti-btn ti-btn-icon ti-btn-instagram btn-wave">
                ...
                <div className="xl:col-span-2 col-span-12">
                    <div className="box">
                        <div className="box-body">
                            <img src={media4} className="card-img mb-4 !rounded-md"
                                alt="..." />
                ...
                <div className="xl:col-span-2 col-span-12">
                    <div className="box">
                        <div className="box-body">
                            <img src={media9} className="card-img mb-4 !rounded-md"
                                alt="..." />
                ...
                <div className="xl:col-span-2 col-span-12">
                    <div className="box">
                        <div className="box-body">
                            <img src={media15} className="card-img mb-4 !rounded-md"
                                alt="..." />
                ...
                <div className="xl:col-span-3 col-span-12">
                    <div className="box text-center">
                        ...
                        <div className="box-body">
                            ...
                            <Link to="#" className="ti-btn ti-btn-primary-full mt-2">Read More</Link>
                ...
                <div className="xl:col-span-4 col-span-12">
                    <div className={`box ${isFullscreen ? "box-fullscreen" : ""}`} onClick={handleBoxClick}>
                        <div className="box-header justify-between">
                            <div className="box-title">
            ...
            <div className="grid grid-cols-12 md:gap-6">
                ...
                <div className="xl:col-span-4 col-span-12">
                    <div className="box">
                        ...
                        <img src={media28} className="!rounded-b-md"
                            alt="..." />
                    </div>
                </div>
                <div className="xl:col-span-4 col-span-12">
                ...
                <div className="xl:col-span-4 col-span-12">
                    <div className="box">
                        ...
                        <img src={media33} className="!rounded-b-md"
                            alt="..." />
                    </div>
                </div>
            </div>
                ...
                <div className="xl:col-span-4 col-span-12">
                    <div className="box overlay-card">
                        ...
                        <div className="card-img-overlay flex flex-column p-0">
                            ...
                            <div className="box-body text-white  overflow-y-scroll">
                    ...
                    <div className="box overlay-card">
                        ...
                        <div className="card-img-overlay flex flex-column p-0 over-content-bottom">
                            <div className="box-body text-white">
                                ...
                                <div className="card-text mb-2 !text-white text-truncate">There are many variations of passages of
                                    Lorem Ipsum available, but the majority have suffered alteration in some form,
                                    by injected humour, or randomised words which don't look even.</div>
                                <div className="card-text !text-white">Last updated 3 mins ago</div>
                            </div>
                        ...
                        <div className="box-body">
                            <div className="flex items-center w-full">
                                ...
                                <div className="">
                                    ...
                                    <p className={`mb-0 opacity-[0.7] text-[.75rem] text-${idx.class}`}>{idx.text2}</p>
                                </div>
                                <div className="ms-auto">
                                    <Link aria-label="anchor" to="#" className={`text-${idx.class}`}><i className="bi bi-three-dots-vertical"></i></Link>
                                </div>
                            </div>
                        </div>
                    </div>
