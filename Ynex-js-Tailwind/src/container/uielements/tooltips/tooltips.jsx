...
import { colortooltip, tooltipdirection } from './tooltipdata';
import { Link } from 'react-router-dom';
import Showcode from '../../../components/ui/showcode/showcode';
import { tooltip1, tooltip2, tooltip3, tooltip5, tooltip6, tooltip7 } from '../../../components/ui/data/uielementsdata';
...
const Tooltips = () => {
  return(
  <Fragment>
                <Pageheader currentpage="Tooltip" activepage="Ui Elements" mainpage="Tooltip" />
                            ...
                            <div className="ti-btn-list space-x-2 rtl:space-x-reverse ">
                                ...
                                <div className={`hs-tooltip ti-main-tooltip ${idx.class}`} key={Math.random()}>
                                    <button type="button" className={`hs-tooltip-toggle ti-btn ti-btn-${idx.color}`}>
                                        {idx.text}
                                        <span
                                            className={`hs-tooltip-content ti-main-tooltip-content py-1 px-2 !bg-${idx.class1}  !text-xs !font-medium
                                             !text-${idx.textcolor} shadow-sm dark:bg-slate-700`}
                                            role="tooltip">
                                            {idx.text}
                                        </span>
                                    </button>
            ...
            <div className="grid grid-cols-12 gap-6">
                ...
                <div className="xl:col-span-4 col-span-12">
                    <Showcode title="With an Svg's" code={tooltip7} customCardBodyClass="flex">
                            <div className="hs-tooltip ti-main-tooltip [--placement:top]">
