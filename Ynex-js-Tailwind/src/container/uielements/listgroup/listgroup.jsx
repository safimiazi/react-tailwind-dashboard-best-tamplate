...
import { ActiveButtons, BasicButtons, ContextualButtons, ContextualButtons1, DisableItems, LinksButtons, Solidcolors } from './listgroupdata';
import { Link } from 'react-router-dom';
import Showcode from '../../../components/ui/showcode/showcode';
import { list1, list10, list12, list13, list14, list15, list16, list2, list3, list4, list5, list6, list7, list8, list9 } from '../../../components/ui/data/uielementsdata';
...
const Listgroup= () => {
  ...
  <Fragment>
            ...
            <div className="grid grid-cols-12 gap-x-6">
                ...
                <div className="xl:col-span-4 col-span-12">
                    <Showcode title="Disable Items" code={list3}>
                            <ul className="ti-list-group">
                                    ...
                                    {LinksButtons.map((idx) => (
                                        <li className={`ti-list-group-item ti-list-group-item-action ${idx.class1} ${idx.color1}`} key={Math.random()}>
                                            <Link to="#"
                                                ...
                                                <div className="flex items-center">
                                                    <div>
                                                        <span className={`avatar avatar-xs bg-${idx.class} dark:bg-${idx.class2} !text-${idx.color}textcolor avatar-rounded`}>
                                                            {idx.text1}
                                                        </span>
                                                    </div>
            ...
            <div className="grid grid-cols-12 gap-x-6">
                <div className="xl:col-span-4 col-span-12">
                    <Showcode title="Sub Headings" code={list16} customCardClass="text-defaulttextcolor text-defaultsize">
