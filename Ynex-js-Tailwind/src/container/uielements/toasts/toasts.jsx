...
import { toast1, toast2, toast3, toast4, toast5, toast6 } from '../../../components/ui/data/uielementsdata';
...
const Toasts = () => {
  ...
  <Fragment>
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Taost Message With Loading Indicator" code={toast5}>
                            <div className="ti-toast bg-white dark:bg-bodybg dark:border-white/10" role="alert">
