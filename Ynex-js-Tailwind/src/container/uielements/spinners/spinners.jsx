...
import { Buttonspinner, Colorspinner } from './spinnerdata';
import Showcode from '../../../components/ui/showcode/showcode';
import { spinner1, spinner10, spinner2, spinner3, spinner4, spinner5, spinner6, spinner7, spinner8, spinner9 } from '../../../components/ui/data/uielementsdata';
...
const Spinners= () => {
  ...
  <Fragment>
            ...
            <div className="grid grid-cols-12  gap-6">
                ...
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Colors" code={spinner2} customCardBodyClass="flex flex-wrap gap-2">
                            {Colorspinner.map((idx) =>( 
                            <div className={`ti-spinner text-${idx.color}`} role="status" key={Math.random()}>
                                <span className="sr-only">Loading...</span>
                            </div>
                            ))}
                        </Showcode>
            ...
            <div className="grid grid-cols-12  gap-6">
                ...
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Alignment Margine" code={spinner8}>
                ...
                <div className="xl:col-span-12 col-span-12">
                    <Showcode title="Buttons" code={spinner10} >
                                ...
                                {Buttonspinner.map((idx)=>(
                                    <button type="button" className={`ti-btn ti-btn-disabled ti-btn-${idx.color} me-2`} disabled key={Math.random()} >
