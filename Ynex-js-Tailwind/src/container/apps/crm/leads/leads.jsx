    ...
    const openFileInput = () => {
      if (fileInputRef.current) {
        fileInputRef.current.click();
          ...
          //Delete function
          const [manageInvoiceData, setManageInvoiceData] = useState([...Loopingdata1]);
            ...
            <div className="box-header flex items-center justify-between flex-wrap gap-4">
                ...
                <div className="flex flex-wrap gap-2">
                    ...
                    <div className="hs-dropdown ti-dropdown">
                        <Link to="#" className="ti-btn ti-btn-light !py-1 !px-2 !text-[0.75rem] !m-0 btn-wave waves-effect waves-light" aria-expanded="false">
                            ...
                            <tr className="border border-defaultborder crm-contact min-w-full" key={Math.random()}>
                                ...
                                <td>
                                    <div className='space-x-2 rtl:space-x-reverse'>
                                        <Link aria-label="anchor" to="#" className="ti-btn ti-btn-sm ti-btn-warning"><i className="ri-eye-line"></i></Link>
                            ...
                            <div className="mb-0 text-center">
                                <span className="avatar avatar-xxl avatar-rounded">
                                    ...
                                    <span className="badge rounded-pill bg-primary avatar-badge" onClick={openFileInput}>
                                        <input type="file" name="photo" className="absolute w-full h-full opacity-0" id="profile-change" ref={fileInputRef}
