                        ...
                        <div className="grid grid-cols-12 md:gap-x-[3rem]">
                            <div className="xl:col-span-4 col-span-12">
                                ...
                                <Swiper
                                                                ...
                                                                className="mySwiper2  swiper-preview-details bg-light product-details-page rounded-md"
                                                            >
                                                            ...
                                                            <Link to="#">
                                                                <div className="flex items-start">
                                                                    ...
                                                                    <div className="flex-grow">
                                                                        ...
                                                                        <p className="mb-0">
                                                                            <span className="badge bg-success !text-white">{idx.text2}<i className="ri-heart-3-fill align-middle ms-1"></i></span>
                                                                            <span className="text-[#8c9097] dark:text-white/50 ms-1">{idx.text3}</span>
                                                                        </p>
                                                                    </div>
                                                                    <div className="text-center">
                                                                        <p className="mb-0 text-[1rem] font-semibold">
                                                                            <span className="avatar avatar-xs avatar-rounded p-1"><img src={ethereum} alt="" /></span>{idx.text4}
                                                                        </p>
                                                                        <p className="mb-0 text-[#8c9097] dark:text-white/50">
                                                                            <s><span className="avatar avatar-xs avatar-rounded p-1"><img src={ethereum} alt="" /></span>{idx.text5}</s>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </Link>
                            ...
                            <div className="xl:col-span-8 col-span-12">
                                <div className="xxl:mt-0 mt-4">
                                    ...
                                    <p className="text-[1.125rem] mb-4">
                                        ...
                                        <span className="font-semibold text-[#8c9097] dark:text-white/50"><Link className="text-info text-[0.875rem]" to="#">(2.4k Likes)</Link></span>
                                    </p>
                                    <div className="grid grid-cols-12 mb-6">
                                        <div className="xxl:col-span-3 xl:col-span-12 col-span-12">
                                            ...
                                            <p className="mb-1"><span className="h3"><span className="avatar avatar-sm avatar-rounded p-1 bg-light"><img src={ethereum} alt="" /></span>1.299<sup className="text-[0.875rem] inline-flex">.00</sup></span><span className="ms-3 badge bg-danger-transparent">50% Off</span></p>
                                            ...
                                            <div className="xxl:col-span-4 xl:col-span-12 lg:col-span-12 md:col-span-12 sm:col-span-12 col-span-12">
                                                ...
                                                <div className="flex items-center mb-4" key={Math.random()}>
                                                    ...
                                                    <div className="progress progress-xs flex-grow">
                                                        <div className={`progress-bar !bg-${idx.color} !text-white w-[${idx.now}%]`} aria-valuenow={idx.now} aria-valuemin={0} aria-valuemax={100}>
                                                        </div>
                                                    </div>
