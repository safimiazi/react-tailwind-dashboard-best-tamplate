...
import { Liveauctiondata, Liveauctiondata1 } from './liveauctiondata';
                            ...
                            <div className="box custom-box">
                                <div className="box-body !p-4">
                                    <div className="mb-4 overflow-hidden relative">
                                        ...
                                        <Link to="#" className="nft-btn" aria-label="Like"><i className="ti ti-heart"></i></Link>
                                    ...
                                    <div className="text-[.9375rem] font-semibold mb-2"><Link to="#">{idx.heading}</Link></div>
                                    <div className="flex items-end flex-wrap gap-2">
                                        ...
                                        <Link to="#" className="ti-btn ti-btn-primary btn-wave">Place Bid</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="box custom-box overflow-hidden">
                                <div className="box-header justify-between">
                                    ...
                                    <div className="hs-dropdown ti-dropdown">
                                        <Link to="#" className="p-2 text-[.75rem] text-[#8c9097] dark:text-white/50" aria-expanded="false">
                                        ...
                                        <li className="list-group-item !border-b-0 !border-e-0 !border-s-0">
                                            <div className="flex gap-4 items-center ">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="text-[.8125rem]">Purchased from <Link to="#" className="underline">Cyber Canvas</Link> for <span className="font-semibold text-[.75rem] text-pink">1.345ETH</span>.</div>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
