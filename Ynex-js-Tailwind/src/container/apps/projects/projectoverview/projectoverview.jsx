                ...
                <div className="xl:col-span-9 col-span-12">
                    <div className="box custom-box">
                        <div className="box-header justify-between flex">
                            ...
                            <div>
                                <Link to={`${import.meta.env.BASE_URL}apps/projects/createproject/`} className="ti-btn !py-1 !px-2 !text-[0.75rem] ti-btn-secondary btn-wave"><i className="ri-add-line align-middle me-1 font-semibold"></i>Create Project</Link>
                            </div>
                        </div>
                            ...
                            <ul className="list-unstyled profile-timeline">
                                <li>
                                    <div>
                                        ...
                                        <p className="mb-2">
                                            <b>You</b> Commented on <b>Work Process</b> in this project <Link className="text-secondary" to="#!"><u>#New Project</u></Link>.<span className="float-end text-[0.6875rem] text-[#8c9097] dark:text-white/50">24,Dec 2023 - 14:34</span>
                                        </p>
                                ...
                                <li>
                                    <div>
                                        <span className="avatar avatar-sm  profile-timeline-avatar">
                                            <img src={face11} alt="" className="!rounded-full" />
                                        </span>
                                ...
                                <li>
                                    <div>
                                        <span className="avatar avatar-sm profile-timeline-avatar">
                                            <img src={media39} alt="" className="!rounded-full" />
                                        </span>
                                        <p className="mb-1">
                                            <b>Json</b> Commented on Project <Link className="text-secondary" to="#"><u>#UI Technologies</u></Link>.<span className="float-end text-[0.6875rem] text-[#8c9097] dark:text-white/50">24,Dec 2023 - 14:34</span>
                                        </p>
                    ...
                    <div className="box custom-box overflow-hidden">
                        ...
                        <div className="box-body !p-0">
                            <ul className="list-group list-group-flush">
                                <li className="list-group-item !border-x-0 !border-t-0">
                                    <div className="flex items-center">
                                        <div className="me-2">
                                        ...
                                        <div className="flex-grow">
                                            <Link to="#"><span className="block font-semibold">Full Project</span></Link>
                                ...
                                <li className="list-group-item !border-x-0">
                                    <div className="flex items-center">
                                        ...
                                        <div className="flex-grow">
                                            <Link to="#"><span className="block font-semibold">assets.zip</span></Link>
                                ...
                                <li className="list-group-item !border-x-0">
                                    <div className="flex items-center">
                                        ...
                                        <div className="flex-grow">
                                            <Link to="#"><span className="block font-semibold">image-1.png</span></Link>
                                ...
                                <li className="list-group-item !border-x-0">
                                    <div className="flex items-center">
                                        ...
                                        <div className="flex-grow">
                                            <Link to="#"><span className="block font-semibold">doc.zip</span></Link>
                                ...
                                <li className="list-group-item !border-x-0 !border-b-0">
                                    <div className="flex items-center">
                                        <div className="me-2 leading-none">
                                            <span className="avatar !rounded-full bg-light">
                                                <img src={filemanager3} alt="" />
                                        ...
                                        <div className="flex-grow">
                                            <Link to="#"><span className="block font-semibold">landing.zip</span></Link>
