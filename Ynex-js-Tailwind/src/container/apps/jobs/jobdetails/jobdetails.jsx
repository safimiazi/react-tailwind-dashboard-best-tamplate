                                ...
                                <div className="sm:flex flex-wrap gap-2">
                                    ...
                                    <div>
                                        ...
                                        <div className="popular-tags mb-2 sm:mb-0 space-x-2 rtl:space-x-reverse">
                                            <Link to="#" className="badge !rounded-full bg-info/10 text-info"><i className="bi bi-clock me-1"></i>Full Time</Link>
                                            <Link to="#" className="badge !rounded-full bg-danger/10 text-danger"><i className="bi bi-briefcase me-1"></i>13 Openings</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div className="box custom-box featured-jobs">
                                            <div className="box-body">
                                                ...
                                                <div className="sm:flex mb-4">
                                                    ...
                                                    <div className="ms-2">
                                                        <h5 className="font-semibold mb-0 flex items-center"><Link to="#"> HTML Developer</Link></h5>
                                                ...
                                                <div className="popular-tags mb-4 space-x-2 rtl:space-x-reverse">
                                                    <Link to="#" className="badge !rounded-full bg-light text-default"><i className="bi bi-geo-alt text-muted me-1"></i> Hyderabad</Link>
                                                    <Link to="#" className="badge !rounded-full bg-light text-default"><i className="bi bi-mortarboard text-muted me-1"></i> Graduate</Link>
                                                    <Link to="#" className="badge !rounded-full bg-light text-default"><i className="bi bi-clock text-muted me-1"></i> Min - 2Years</Link>
                                                </div>
                                        ...
                                        <div className="box custom-box featured-jobs">
                                            <div className="box-body">
                                                ...
                                                <div className="sm:flex mb-4">
                                                    ...
                                                    <div className="ms-2">
                                                        <h5 className="font-semibold mb-0 flex items-center"><Link to="#"> React Developer</Link></h5>
                                                        <Link to="#"><i className="bi bi-building"></i> Infratech PVT LTD</Link>
                                                    </div>
                                                </div>
                                                <div className="popular-tags mb-4 space-x-2 rtl:space-x-reverse">
                                                    <Link to="#" className="badge !rounded-full bg-light !text-defaulttextcolor"><i className="bi bi-geo-alt text-muted me-1"></i> Hyderabad</Link>
                                                    <Link to="#" className="badge !rounded-full bg-light !text-defaulttextcolor"><i className="bi bi-mortarboard text-muted me-1"></i> Graduate</Link>
                                                    <Link to="#" className="badge !rounded-full bg-light !text-defaulttextcolor"><i className="bi bi-clock text-muted me-1"></i> Min - 2Years</Link>
                                                </div>
                                                <div className="sm:flex justify-between">
                                                    <h6 className="font-semibold mb-0">$25,000 - $35,000</h6>
                                                    <Link to="#" className="text-primary font-semibold text-[.875rem]">
                                        ...
                                        <div className="box custom-box featured-jobs">
                                            <div className="box-body">
                                                ...
                                                <div className="sm:flex mb-4">
                                                    ...
                                                    <div className="ms-2">
                                                        <h5 className="font-semibold mb-0 flex items-center"><Link to="#"> Vuejs Developer</Link></h5>
                                        ...
                                        <div className="box custom-box featured-jobs">
                                            <div className="box-body">
                                                ...
                                                <div className="sm:flex mb-4">
                                                    ...
                                                    <div className="ms-2">
                                                        <h5 className="font-semibold mb-0 flex items-center"><Link to="#"> Wordpress Developer</Link></h5>
                        ...
                        <div className="box custom-box">
                            <div className="box-body">
                                <div className="">
                                    ...
                                    <label className="form-check-label inline" htmlFor="invalidCheck">
