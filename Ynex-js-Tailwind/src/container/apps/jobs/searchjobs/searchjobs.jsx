...
import LabeledTwoThumbs1 from '../searchcandidate/searchcandiadatedata';
                        ...
                        <div className="box custom-box featured-jobs">
                            <div className="box-body">
                                ...
                                <div className="flex mb-4 flex-wrap gap-2 items-center">
                                    ...
                                    <div>
                                        <h5 className="font-semibold mb-0 flex items-center"><Link to="#"> HTML Developer - Fresher</Link></h5>
                                ...
                                <div className="popular-tags mb-4 space-x-2 rtl:space-x-reverse">
                                    ...
                                    <Link to="#" className="badge !rounded-full bg-light !text-defaulttextcolor"><i className="bi bi-briefcase text-muted me-1"></i> 13 Openings</Link>
                                    ...
                                    <Link to="#" className="badge !rounded-full bg-light !text-defaulttextcolor"><i className="bi bi-moon-stars text-muted me-1"></i> flexible-shift</Link>
                                </div>
                        ...
                        <div className="box custom-box featured-jobs">
                            <div className="box-body">
                                ...
                                <div className="flex mb-4 flex-wrap gap-2 items-center">
                                    ...
                                    <div>
                                        <h5 className="font-semibold mb-0 flex items-center"><Link to="#"> React Lead Developer</Link></h5>
                        ...
                        <div className="box custom-box featured-jobs">
                            <div className="box-body">
                                ...
                                <div className="flex mb-4 flex-wrap gap-2 items-center">
                                    ...
                                    <div>
                                        <h5 className="font-semibold mb-0 flex items-center"><Link to="#"> Vuejs Frontend Developer</Link></h5>
                        ...
                        <div className="box custom-box featured-jobs">
                            <div className="box-body">
                                ...
                                <div className="flex mb-4 flex-wrap gap-2 items-center">
                                    ...
                                    <div>
                                        <h5 className="font-semibold mb-0 flex items-center"><Link to="#"> Wordpress Developer - Remote</Link></h5>
