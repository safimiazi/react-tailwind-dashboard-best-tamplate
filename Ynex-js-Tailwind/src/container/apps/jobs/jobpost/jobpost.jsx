...
import { jobpost1, jobpost10, jobpost11, jobpost2, jobpost3, jobpost4, jobpost5, jobpost6, jobpost7, jobpost8, jobpost9, jobtype } from './jobpostdata';
                        ...
                        <div className="box-body">
                            <div className="grid grid-cols-12 sm:gap-6 mb-4">
                                ...
                                <div className="xl:col-span-6 col-span-12">
                                    ...
                                    <Select options={jobtype} classNamePrefix='Select2' menuPlacement='auto' className="" placeholder="" defaultValue={[jobtype[0]]} />
                                </div>
                                <div className="xl:col-span-6 col-span-12">
