                                ...
                                <div className="sm:flex items-center sm:flex-wrap justify-between gap-2">
                                    <div className="md:flex">
                                        ...
                                        <div className="sm:ms-4">
                                            ...
                                            <div className="popular-tags space-x-1 rtl:space-x-reverse">
                                                <Link to="#" className="badge !rounded-full bg-info/10  text-info mb-2"><i className="bi bi-moon-stars me-1"></i>Full Time</Link>
                                                <Link to="#" className="badge !rounded-full bg-danger/10 text-danger mb-2"><i className="bi bi-clock me-1"></i> Immediate Joinee</Link>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="box custom-box">
                                            <div className="box-body">
                                                ...
                                                <div className="sm:flex mb-3 items-center">
                                                    ...
                                                    <div className="ms-2">
                                                        <h5 className="font-semibold mb-0 sm:flex items-center"><Link to="#"> Brenda Simpson <i className="bi bi-check-circle-fill text-success text-[1rem]" title="Verified candidate"></i></Link></h5>
                                                        <div className="sm:flex gap-2">
                                                        ...
                                                        <div className="sm:flex items-center text-[0.75rem] text-[#8c9097] dark:text-white/50">
                                                            ...
                                                            <div className="min-w-fit ms-2">
                                                                <span className="text-warning"><i className="bi bi-star-fill"></i></span>
                                                                <span className="text-warning"><i className="bi bi-star-fill"></i></span>
                                                                <span className="text-warning ms-1"><i className="bi bi-star-fill"></i></span>
                                                                <span className="text-warning ms-1"><i className="bi bi-star-fill"></i></span>
                                                                <span className="text-warning ms-1"><i className="bi bi-star-half"></i></span>
                                                            </div>
                                                            <Link to="#" className="ms-1 min-w-fit text-[#8c9097] dark:text-white/50">
                                                                <span>(142)</span>
                                                                <span>Ratings</span>
                                                ...
                                                <div className="popular-tags space-x-1 rtl:space-x-reverse">
                                                    <Link to="#" className="badge !rounded-full bg-light !text-defaulttextcolo"><i className="bi bi-mortarboard text-[#8c9097] dark:text-white/50 me-1"></i> Graduate</Link>
                                                    <Link to="#" className="badge !rounded-full bg-light !text-defaulttextcolo ms-1"><i className="bi bi-moon-stars text-[#8c9097] dark:text-white/50 me-1"></i> sm:flexible-shift</Link>
                                                    <Link to="#" className="badge !rounded-full bg-light !text-defaulttextcolo ms-1"><i className="bi bi-clock text-[#8c9097] dark:text-white/50 me-1"></i> Immediate Joinee</Link>
                                                    <Link to="#" className="badge !rounded-full bg-light !text-defaulttextcolo ms-1"><i className="bi bi-broadcast text-[#8c9097] dark:text-white/50 me-1"></i> Good at English</Link>
                                                </div>
                                            </div>
                                            <div className="box-footer">
                                                <div className="sm:flex items-center gap-3">
                                                    <h6 className="mb-0 font-semibold">Skills :</h6>
                                                    <div className="popular-tags sm:flex-grow space-x-1 rtl:space-x-reverse">
                                                        <Link to="#" className="badge !rounded-full bg-light !text-defaulttextcolor">HTML</Link>
                                                        <Link to="#" className="badge !rounded-full bg-light !text-defaulttextcolor">CSS</Link>
                                                        <Link to="#" className="badge !rounded-full bg-light !text-defaulttextcolor">Javascript</Link>
                                                        <Link to="#" className="badge !rounded-full bg-light !text-defaulttextcolor">Angular</Link>
                                                        <Link to="#" className="badge !rounded-full bg-primary/10 text-primary"><i className="bi bi-plus"></i> More</Link>
                                                    </div>
                                                    <div>
                                                        <Link to="#" className="badge badge-md !rounded-full bg-info/10 text-info" title="1 year bond accepted"><i className="bi bi-hand-thumbs-up me-1"></i>1 year bond accepted</Link>
                                                        <Link to="#" className="badge badge-md !rounded-full bg-primary/10 text-primary ms-1"><i className="bi bi-briefcase me-1"></i>Exp : 2 Years</Link>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="box custom-box">
                                            <div className="box-body">
                                                ...
                                                <div className="sm:flex mb-3 items-center">
                                                    ...
                                                    <div className="ms-2">
                                                        <h5 className="font-semibold mb-0 sm:flex items-center"><Link to="#"> Dwayne Stort <i className="bi bi-check-circle-fill text-success text-[1rem]" title="Verified candidate"></i></Link></h5>
                                                        <div className="sm:flex gap-2">
                                                        ...
                                                        <div className="sm:flex items-center text-[0.75rem] text-[#8c9097] dark:text-white/50">
                                                            ...
                                                            <div className="min-w-fit ms-2">
                                                                ...
                                                                <span className="text-warning ms-1"><i className="bi bi-star-fill"></i></span>
                                                                <span className="text-warning ms-1"><i className="bi bi-star-fill"></i></span>
                                                                <span className="text-warning ms-1"><i className="bi bi-star"></i></span>
                                                                <span className="text-warning ms-1"><i className="bi bi-star"></i></span>
                                                            </div>
                                                ...
                                                <div className="popular-tags space-x-1 rtl:space-x-reverse">
                                                    ...
                                                    <Link to="#" className="badge !rounded-full bg-light !text-defaulttextcolor ms-1"><i className="bi bi-moon-stars text-[#8c9097] dark:text-white/50 me-1"></i> sm:flexible-shift</Link>
                                                    <Link to="#" className="badge !rounded-full bg-light !text-defaulttextcolor ms-1"><i className="bi bi-clock text-[#8c9097] dark:text-white/50 me-1"></i> Within 10 Days</Link>
                                                    <Link to="#" className="badge !rounded-full bg-light !text-defaulttextcolor ms-1"><i className="bi bi-broadcast text-[#8c9097] dark:text-white/50 me-1"></i> Good at English</Link>
                                                </div>
                                            </div>
                                            <div className="box-footer">
                                                <div className="sm:flex items-center gap-3">
                                                    <h6 className="mb-0 font-semibold">Skills :</h6>
                                                    <div className="popular-tags sm:flex-grow space-x-1 rtl:space-x-reverse ">
                                                        <Link to="#" className="badge !rounded-full bg-light !text-defaulttextcolor ms-1">React</Link>
                                                        <Link to="#" className="badge !rounded-full bg-light !text-defaulttextcolor ms-1">Javascript</Link>
                                                        <Link to="#" className="badge !rounded-full bg-light !text-defaulttextcolor ms-1">React Navtive</Link>
                                                        <Link to="#" className="badge !rounded-full bg-primary/10 text-primary"><i className="bi bi-plus"></i> More</Link>
                                                    </div>
                                                    <div>
                                                        <Link to="#" className="badge badge-md !rounded-full bg-info/10 text-info" title="1 year bond accepted"><i className="bi bi-hand-thumbs-up me-1"></i>2 years bond accepted</Link>
                                                        <Link to="#" className="badge badge-md !rounded-full bg-primary/10 text-primary ms-1"><i className="bi bi-briefcase me-1"></i>Exp : 4 Years</Link>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="box custom-box">
                                            <div className="box-body">
                                                ...
                                                <div className="sm:flex mb-3 items-center">
                                                    ...
                                                    <div className="ms-2">
                                                        <h5 className="font-semibold mb-0 sm:flex items-center"><Link to="#"> Jasmine Kova <i className="bi bi-check-circle-fill text-success text-[1rem]" title="Verified candidate"></i></Link></h5>
                                                        <div className="sm:flex gap-2">
                                            ...
                                            <div className="box-footer">
                                                <div className="sm:flex items-center gap-3">
                                                    <h6 className="mb-0 font-semibold">Skills :</h6>
                                                    <div className="popular-tags sm:flex-grow space-x-1 rtl:space-x-reverse">
                                                        <Link to="#" className="badge !rounded-full bg-light !text-defaulttextcolor">Python</Link>
                                                        <Link to="#" className="badge !rounded-full bg-light !text-defaulttextcolor">Java</Link>
                            ...
                            <div className="box-footer">
                                <div className="sm:flex items-center">
                                    ...
                                    <div className="btn-list mb-0">
                                        <button type="button" aria-label="button" className="ti-btn ti-btn-sm ti-btn-primary me-[0.375rem] xl:mb-0">
                                            <i className="ri-facebook-line"></i>
                                        </button>
                                        <button type="button" aria-label="button" className="ti-btn ti-btn-sm ti-btn-secondary me-[0.375rem] xl:mb-0">
                                            <i className="ri-twitter-line"></i>
                                        </button>
                                        <button type="button" aria-label="button" className="ti-btn ti-btn-sm ti-btn-warning me-[0.375rem] xl:mb-0">
                                            <i className="ri-instagram-line"></i>
                                        </button>
                                        <button type="button" aria-label="button" className="ti-btn ti-btn-sm ti-btn-success me-[0.375rem] xl:mb-0">
                                            <i className="ri-github-line"></i>
                                        </button>
                                        <button type="button" aria-label="button" className="ti-btn ti-btn-sm ti-btn-danger xl:mb-0">
                            ...
                            <div className="box-body">
                                <div className="">
                                    ...
                                    <label className="form-check-label" htmlFor="invalidCheck">
                                        By Subscribing you accept to <Link to="#" className="text-success mx-1"><u>privacy policy</u></Link>
                                    </label>
                                </div>
                            </div>
                        </div>
