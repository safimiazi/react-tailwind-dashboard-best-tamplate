                        ...
                        <div className="box custom-box">
                            ...
                            <div className="box-footer">
                                <div className="sm:flex items-center gap-3">
                                    ...
                                    <div>
                                        <div className="hs-tooltip ti-main-tooltip">
                                            <Link to="#" className="hs-tooltip-toggle badge badge-md !rounded-full bg-info/10 text-info me-1">
                                                <i className="bi bi-hand-thumbs-up me-1"></i>1 year bond accepted
                                                <span className="hs-tooltip-content  ti-main-tooltip-content py-1 px-2 !bg-black !text-xs !font-medium !text-white shadow-sm me-1" role="tooltip">
