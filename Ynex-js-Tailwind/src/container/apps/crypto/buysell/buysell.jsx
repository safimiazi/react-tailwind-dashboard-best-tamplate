                            ...
                            <div className="box-body">
                                <div>
                                    <div className="input-group mb-4 sm:flex block !flex-nowrap crypto-buy-sell">
                                        <input type="text" className="form-control crypto-buy-sell-input border-e-0" aria-label="crypto buy select" placeholder="Select Currency" />
                                    ...
                                    <div>
                                        <div className="text-[.875rem] py-2"><span className="font-semibold text-dark inline-flex">Price:</span><span className="text-[#8c9097] dark:text-white/50 ms-2 text-[.875rem] inline-block">6.003435</span><span className="text-dark font-semibold ltr:float-right rtl:float-left">BTC</span></div>
                                        <div className="text-[.875rem] py-2"><span className="font-semibold text-dark inline-flex">Amount:</span><span className="text-[#8c9097] dark:text-white/50 ms-2 text-[.875rem] inline-block">2,34,4543.00</span><span className="text-dark font-semibold ltr:float-right rtl:float-left">LTC</span></div>
                        ...
                        <div className="box custom-box">
                            ...
                            <div className="box-body">
                                <div className="tab-pane !border-0 !p-0" id="sell-crypto1" role="tabpanel"
                                    ...
                                    <div>
                                        <div className="text-[.875rem] py-2"><span className="font-semibold text-dark inline-flex">Price:</span><span className="text-[#8c9097] dark:text-white/50 ms-2 text-[.875rem]">6.003435</span><span className="text-dark font-semibold ltr:float-right rtl:float-left">BTC</span></div>
                                        <div className="text-[.875rem] py-2"><span className="font-semibold text-dark inline-flex">Amount:</span><span className="text-[#8c9097] dark:text-white/50 ms-2 text-[.875rem]">2,34,4543.00</span><span className="text-dark font-semibold ltr:float-right rtl:float-left">LTC</span></div>
                                    </div>
