                        ...
                        <div className="box-footer">
                            <div className="flex items-center justify-between gap-2 flex-wrap">
                                ...
                                <div className="task-details-progress">
                                    ...
                                    <div className="flex items-center flex-wrap">
                                        <div className="progress progress-xs progress-animate flex-grow me-2" style={{width:'70%'}} aria-valuenow={70} aria-valuemin={0} aria-valuemax={100}>
                            ...
                            <ul className="list-none profile-timeline">
                                <li>
                                    <div>
                                        ...
                                        <p className="mb-2">
                                            <b>You</b> Commented on <b>Work Process</b> in this task <Link className="text-secondary" to="#"><u>#New Task</u></Link>.<span className="ltr:float-right rtl:float-left text-[.6875rem] text-[#8c9097] dark:text-white/50">24,Dec 2023 - 14:34</span>
                                        </p>
                                ...
                                <li>
                                    <div>
                                        ...
                                        <p className="mb-1">
                                            <b>Json</b> Commented on Task post <Link className="text-secondary" to="#"><u>#UI Technologies</u></Link>.<span className="ltr:float-right rtl:float-left text-[.6875rem] text-[#8c9097] dark:text-white/50">24,Dec 2023 - 14:34</span>
                                        </p>
                                    ...
                                    <tbody>
                                        ...
                                        <tr className="border-b border-defaultborder">
                                            ...
                                            <td className='space-x-1 rtl:space-x-reverse'>
                                                <span className="badge bg-primary/10 text-primary">UI/Ux</span>
                                                <span className="badge bg-primary/10 text-primary">Designing</span>
                            ...
                            <ul className="list-group list-group-flush">
                                ...
                                <li className="list-group-item">
                                    <div className="flex items-center flex-wrap">
                                        ...
                                        <div className="flex-grow">
                                            <Link to="#"><span className="block font-semibold">Docs.zip</span></Link>
