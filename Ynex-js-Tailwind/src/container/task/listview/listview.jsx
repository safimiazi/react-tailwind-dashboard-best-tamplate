...
import { TransactionsStatistics } from '../../apps/crypto/transactions/transactiondata';
                                                ...
                                                <div className="grid grid-cols-12 gap-4">
                                                    ...
                                                    <div className="xl:col-span-6 col-span-12">
                                                        ...
                                                        <div className="input-group !flex-nowrap">
                                                            <div className="input-group-text text-muted !rounded-e-none !border-e-0"> <i className="ri-calendar-line"></i> </div>
                                                                <DatePicker
                                                            selected={startDate}
                                                ...
                                                />
                                                    ...
                                                    <div className="xl:col-span-12 col-span-12">
                                                        <label className="form-label">Assigned To</label>
                                                          <Select isMulti id="choices-multiple-remove-button1" name="choices-multiple-remove-button1" options={Selectdata} className="!p-0 form-control"
