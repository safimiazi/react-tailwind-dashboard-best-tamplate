...
const Validation = () => {
  ...
  return(
  <Fragment>
          <Pageheader currentpage="Validations" activepage="Forms" mainpage="Validations" />
            ...
            <div className="box-body">
              <form className="ti-validation">
                <div className="grid lg:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <ul className="flex flex-col sm:flex-row">
                      <li className="ti-list-group w-full gap-x-2.5 py-2 px-4 bg-white dark:bg-bodybg border text-gray-800 sm:-ms-px sm:mt-0 !rounded-e-none dark:bg-bgdark dark:border-white/10 dark:text-white">
                      ...
                      <li className="ti-list-group w-full gap-x-2.5 py-2 px-4 bg-white dark:bg-bodybg border text-gray-800 sm:-ms-px sm:mt-0 !rounded-none  dark:bg-bgdark dark:border-white/10 dark:text-white">
                        <div className="relative flex items-start w-full">
                          <div className="flex items-center h-5">
                      ...
                      <li className="ti-list-group w-full gap-x-2.5 py-2 px-4 bg-white dark:bg-bodybg border text-gray-800 sm:-ms-px sm:mt-0 !rounded-s-sm  dark:bg-bgdark dark:border-white/10 dark:text-white">
                        <div className="relative flex items-start w-full">
                          <div className="flex items-center h-5">
                ...
                <div className="my-5">
                  ...
                  <label htmlFor="hs-checkbox-group-1" className="text-sm text-gray-500 ms-3 dark:text-[#8c9097] dark:text-white/50">I agree with the 
                  <Link to="#" className="text-primary hover:underline ms-1">terms and conditions</Link></label>
                </div>
            ...
            <div className="box-body">
              <form className="ti-custom-validation" noValidate>
                <div className="grid lg:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    <label className="ti-form-label dark:text-defaulttextcolor/70 mb-0">Date Of Birth</label>
                    <DatePicker className="ti-form-input !rounded-sm" showIcon selected={startDate1} onChange={(date) => setStartDate1(date)} />
                    <span className="dobError text-red-500 text-xs hidden">error</span>
                  </div>
                  <div className="space-y-2">
                    <label className="ti-form-label dark:text-defaulttextcolor/70 mb-0">Gender</label>
                    <ul className="flex flex-col sm:flex-row sm:space-y-0 space-y-2">
                      <li className="ti-list-group w-full gap-x-2.5 py-2 px-4 bg-white dark:bg-bodybg border text-gray-800 sm:!rounded-e-none sm:!rounded-s-sm border-e-0 sm:-ms-px sm:mt-0 dark:bg-bgdark dark:border-white/10 dark:text-white">
                        <div className="relative flex items-start w-full">
                          <div className="flex items-center h-5">
                      ...
                      <li className="ti-list-group w-full gap-x-2.5 py-2 px-4 bg-white dark:bg-bodybg border text-gray-800 sm:-ms-px sm:!rounded-none sm:!border-e-0 dark:bg-bgdark dark:border-white/10 dark:text-white">
                        <div className="relative flex items-start w-full">
                          <div className="flex items-center h-5">
                            <input id="ti-radio-validation-12" name="ti-radio-validation" type="radio" className="ti-form-radio" required />
                          </div>
                          <label htmlFor="ti-radio-validation-12" className="ms-3 block w-full text-sm text-gray-600 dark:text-[#8c9097] dark:text-white/50">
                            Male
                          </label>
                        </div>
                      </li>

                      <li className="ti-list-group w-full gap-x-2.5 py-2 px-4 bg-white dark:bg-bodybg border text-gray-800 sm:!rounded-s-none sm:!rounded-e-sm  dark:bg-bgdark dark:border-white/10 dark:text-white">
                        <div className="relative flex items-start w-full">
                          <div className="flex items-center h-5">
                            <input id="ti-radio-validation-13" name="ti-radio-validation" type="radio" className="ti-form-radio" required />
                          </div>
                          <label htmlFor="ti-radio-validation-13" className="ms-3 block w-full text-sm text-gray-600 dark:text-[#8c9097] dark:text-white/50">
                            Others
                          </label>
                        </div>
                      </li>
                ...
                <div className="my-5">
                  ...
                  <label htmlFor="hs-checkbox-group-12" className="text-sm text-gray-500 sm:ms-3 dark:text-[#8c9097] dark:text-white/50">I agree with the <Link to="#" className="text-primary hover:underline ms-1">terms and conditions</Link></label>
                </div>
