          ...
          <div className="box">
            ...
            <div className="box-body">
              <div>
                ...
                <div className="relative">
                  <input type="text" id="hs-input-with-leading-and-trailing-icon" name="hs-input-with-leading-and-trailing-icon" className="ti-form-input rounded-sm ps-9 pe-16 focus:z-10" />
                  <div className="absolute inset-y-0 start-0 flex items-center pointer-events-none z-20 ps-4">
                    <span className="text-gray-500 dark:text-[#8c9097] dark:text-white/50">$</span>
                  </div>
                  <div className="absolute inset-y-0 end-0 flex items-center pointer-events-none z-20 pe-4">
          ...
          <div className="box">
            ...
            <div className="box-body">
              <div>
                ...
                <div className="relative">
                  <input type="text" id="hs-inline-leading-select-label" className="ti-form-input ps-20 focus:z-10" placeholder="+1 (000) 000-0000" />
          ...
          <div className="box">
            ...
            <div className="box-body">
              <div>
                ...
                <div className="relative">
                  <input type="text" id="hs-inline-leading-pricing-select-label" className="ti-form-input ps-9 pe-20 focus:z-10" />
                  <div className="absolute inset-y-0 start-0 flex items-center pointer-events-none z-20 ps-4">
                    <span className="text-gray-500 dark:text-[#8c9097] dark:text-white/50">$</span>
                  </div>
