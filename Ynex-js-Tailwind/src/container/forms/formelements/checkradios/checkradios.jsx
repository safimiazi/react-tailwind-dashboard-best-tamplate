...
import { radio1, radio10, radio11, radio12, radio13, radio14, radio2, radio3, radio4, radio5, radio6, radio7, radio8, radio9 } from '../../../../components/ui/data/formsdata';
...
const Checkradios = () => {
  ...
  <Fragment>
            ...
            <div className="grid grid-cols-12 gap-6">
                ...
                <div className="xl:col-span-6 lg:col-span-6 md:col-span-12 sm:col-span-12 col-span-12">
                    <Showcode title="Switches" code={radio6} customCardBodyClass="flex flex-col gap-y-4">
                            <div className="flex items-center">
                                <input type="checkbox" id="hs-basic-with-description-checked" className="ti-switch" defaultChecked />
                                <label htmlFor="hs-basic-with-description-checked" className="text-sm text-gray-500 ms-3 
                                dark:text-[#8c9097] dark:text-white/50">Checked</label>
                            </div>
                            <div className="flex items-center">
                                <input type="checkbox" id="hs-basic-with-description-unchecked" className="ti-switch" />
                                <label htmlFor="hs-basic-with-description-unchecked" className="text-sm text-gray-500 ms-3
                                 dark:text-[#8c9097] dark:text-white/50">Unchecked</label>
                            </div>
                            <div className="flex items-center">
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xxl:col-span-6 xl:col-span-12 lg:col-span-12 md:col-span-12 sm:col-span-12 col-span-12">
                    <Showcode title="Checkbox Sizes" code={radio7} customCardBodyClass="sm:flex items-center justify-between">
                            <div className="form-check">
                ...
                <div className="xxl:col-span-6 xl:col-span-12 lg:col-span-12 md:col-span-12 sm:col-span-12 col-span-12">
                    <Showcode title="Radio Sizes" code={radio8} customCardBodyClass="sm:flex items-center justify-between">
                            <div className="form-check">
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-6 lg:col-span-12 md:col-span-12 sm:col-span-12 col-span-12">
                    <Showcode title="Inline" code={radio9} customCardBodyClass="sm:flex gap-2">
                ...
                <div className="xl:col-span-6  lg:col-span-12 md:col-span-12 sm:col-span-12 col-span-12">
                    <Showcode title="Reverse" code={radio10}>
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-6  lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                    <Showcode title="Toggle Switches Style-1" code={radio11}>
                ...
                <div className="xl:col-span-6  lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                    <Showcode title="Toggle Switches Style-2" code={radio12}>
                            <div className="grid grid-cols-12 gap-y-1">
                                <div className="xl:col-span-4 col-span-12">
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-6  lg:col-span-12 md:col-span-12 sm:col-span-12 col-span-12">
                    <Showcode title="Toggle Switch-1 Sizes" code={radio13} customCardBodyClass="flex flex-col">
                ...
                <div className="xl:col-span-6  lg:col-span-12 md:col-span-12 sm:col-span-12 col-span-12 ">
                    <Showcode title="Toggle Switch-2 Sizes" code={radio14}>
                            <div className="flex items-center flex-wrap mb-4">
                                <div className=""><p className="text-muted m-0">Small size toggle switch <code>toggle-sm</code></p></div>
