...
import { Applicants, Bitcoin, Dash, Ethereum, Golem, Sessions, Targetreport, TotalRevenue, WorldMap } from './widgetsdata';
                            ...
                            <div className="box custom-box">
                                <div className="box-body !p-0">
                                    <div className="p-4">
                                        ...
                                        <div className="flex items-center">
                                            <Link to="#" className="flex-grow ti-btn !py-1 !px-2 !text-[0.75rem] ti-btn-light me-2">Short</Link>
                                            <Link to="#" className="flex-grow ti-btn !py-1 !px-2 !text-[0.75rem] ti-btn-primary">Buy</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="box-body">
                            <div className="flex items-start justify-between mb-6">
                                ...
                                <div className="hs-dropdown ti-dropdown">
                                    <Link aria-label="anchor" to="#" className="ti-btn ti-btn-icon ti-btn-sm ti-btn-light"><i className="ti ti-dots"></i></Link>
                                ...
                                <li className="timeline-widget-list">
                                    <div className="flex items-start">
                                        ...
                                        <div className="flex flex-wrap flex-grow items-center justify-between">
                                            ...
                                            <div className="hs-dropdown ti-dropdown">
                                                <Link aria-label="anchor" to="#" className="p-2 text-[1rem] text-[#8c9097] dark:text-white/50">
                ...
                <div className="xl:col-span-6 col-span-12">
                    <div className="box custom-box">
                        <div className="box-header justify-between">
                            ...
                            <div className="hs-dropdown ti-dropdown">
                                <Link to="#" className="p-2 text-[0.75rem] text-[#8c9097] dark:text-white/50">
                    ...
                    <div className="box custom-box">
                        <div className="box-header">
                            ...
                            <div className="ms-auto hs-dropdown ti-dropdown">
                                <Link to="#" className="ti-btn !py-1 !px-2 !text-[0.75rem] ti-btn-primary dropdown-toggle" aria-expanded="false">
                                    Details
                                </Link>
                                <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                                    <li><Link className="ti-dropdown-item" to="#">Action</Link></li>
